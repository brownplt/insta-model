...
(check-not-judgment-holds* (⊢p (desugar-program ((import-from "typing" ("ClassVar")) (class "C" () ((ann-assign "x" (subscript "ClassVar" "int")) (ann-assign "x" (subscript "ClassVar" "int"))))))))
...
(check-judgment-holds* (⊢p (desugar-program ((class "C" () ((assign ("x") (con 42)))) (assert (compare (attribute "C" "x") ((is (con 42)))))))))
...
(check-not-judgment-holds* (⊢p (desugar-program ((import-from "typing" ("ClassVar" "Any")) (class "C1" () ((assign ("x") (con 42)))) (class "C2" ("C1") ((ann-assign "x" (subscript "ClassVar" "int"))))))))

;; conformance_suite/unannotated_class_variables_redeclare_in_subclass_same_type.py
(check-judgment-holds* (⊢p (desugar-program ((import-from "typing" ("ClassVar" "Any")) (class "C1" () ((assign ("x") (con 2)))) (class "C2" ("C1") ((ann-assign "x" (subscript "ClassVar" "Any"))))))))

;; conformance_suite/unannotated_class_variables_shadowed_by_instance_same_class.py
(check-not-judgment-holds* (⊢p (desugar-program ((class "C1" () ((assign ("x") (con 42)) (ann-assign "x" "int")))))))

;; conformance_suite/unannotated_class_variables_shadowed_by_instance_sub_class.py
(check-not-judgment-holds* (⊢p (desugar-program ((class "C1" () ((assign ("x") (con 42)))) (class "C2" ("C1") ((ann-assign "x" "int")))))))
