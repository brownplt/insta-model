...
(check-judgment-holds* (⊢p (desugar-program ((import-from "__static__" ("CheckedDict")) (try-except-else-finally ((expr (call (subscript "CheckedDict" (tuple ("str" "str"))) ((con None))))) ((except-handler "Exception" None (pass))) ((raise (call "Exception" ((con "Should fail."))))) ())))))
...
(check-judgment-holds* (⊢p (desugar-program ((import-from "__static__" ("CheckedDict")) (function-def "as_dyn" (("x" dynamic)) dynamic ((return "x"))) (assign ("x") (call (subscript "CheckedDict" (tuple ("str" "int"))) ((dict (((con "x") (con 2))))))) (try-except-else-finally ((expr (call (attribute "x" "get") ((call "as_dyn" ((con 100))))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()) (try-except-else-finally ((expr (call (attribute "x" "get") ((con "x") (call "as_dyn" ((con "abc"))))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ())))))
...
(check-judgment-holds* (⊢p (desugar-program ((import-from "typing" ("Any" "Optional")) (import-from "__static__" ("CheckedDict")) (ann-assign "x" "Any" (call (subscript "CheckedDict" (tuple ("str" (subscript "Optional" "str")))) ())) (assign ((subscript "x" (con "abc"))) (con None)) (assign ("x") (call (subscript "CheckedDict" (tuple ((subscript "Optional" "str") "str"))) ())) (assign ((subscript "x" (con None))) (con "abc"))))))
...
(check-judgment-holds* (⊢p (desugar-program ((assign ("l") (list ())) (for "x" (list ((con 1) (con 2) (con 3))) ((expr (call (attribute "l" "append") ("x")))) ()) (assert (compare "l" ((== (list ((con 1) (con 2) (con 3)))))))))))

;; conformance_suite/iterate-str.py
(check-judgment-holds* (⊢p (desugar-program ((assign ("l") (list ())) (for "x" (con "abc") ((expr (call (attribute "l" "append") ("x")))) ()) (assert (compare "l" ((== (list ((con "a") (con "b") (con "c")))))))))))
