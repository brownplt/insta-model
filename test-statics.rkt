...
(check-judgment-holds* (⊢p (desugar-program ((import-from "__static__" ("CheckedDict")) (ann-assign "x" (subscript "CheckedDict" (tuple ("int" "str"))) (call (subscript "CheckedDict" (tuple ("int" "str"))) ((dict (((con 2) (con "a")) ((con 3) (con 4)))))))))))

;; conformance_suite/CheckedDict_from_good_dict.py
(check-judgment-holds* (⊢p (desugar-program ((import-from "__static__" ("CheckedDict")) (ann-assign "x" (subscript "CheckedDict" (tuple ("int" "str"))) (call (subscript "CheckedDict" (tuple ("int" "str"))) ((dict (((con 2) (con "a")) ((con 3) (con "b")))))))))))
...
(check-judgment-holds* (⊢p (desugar-program ((class "C1" () ((ann-assign "x" "str"))) (class "C2" ("C1") ((ann-assign "y" "int"))) (assign "c" (call "C2" ())) (assign (attribute "c" "x") (con "foo")) (assert (compare (attribute "c" "x") ((== (con "foo")))))))))
