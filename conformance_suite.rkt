...
(check-not-judgment-holds* (⊢p ((import-from "__static__" (CheckedDict)) (define/assign x (subscript CheckedDict (tuple int str)) ((subscript CheckedDict (tuple int str)) 42)))))

;; conformance_suite/CheckedDict_from_dict_pos.py
(check-judgment-holds* (⊢p ((import-from "__static__" (CheckedDict)) (define/assign x (subscript CheckedDict (tuple int str)) ((subscript CheckedDict (tuple int str)) (dict (2 "a") (3 "b")))))))
...
(check-judgment-holds* (⊢p ((import-from "__static__" (PyDict)) (define/assign x PyDict (dict (1 "foo") ("bar" 2))) (delete (subscript x "bar")))))

;; conformance_suite/PyDict_insert.py
(check-judgment-holds* (⊢p ((import-from "__static__" (PyDict)) (define/assign x PyDict (dict (1 "foo") ("bar" 2))) (define/assign (subscript x "new") "hello"))))

;; conformance_suite/PyDict_is_inhabitable.py
(check-judgment-holds* (⊢p ((import-from "__static__" (PyDict)) (define/assign x PyDict (dict (1 "foo") ("bar" 2))))))

;; conformance_suite/PyDict_lookup_bad_key.py
(check-judgment-holds* (⊢p ((import-from "__static__" (PyDict)) (define/assign x PyDict (dict (1 "foo") ("bar" 2))) (subscript x "baz"))))

;; conformance_suite/PyDict_lookup_good_key.py
(check-judgment-holds* (⊢p ((import-from "__static__" (PyDict)) (define/assign x PyDict (dict (1 "foo") ("bar" 2))) (subscript x "bar"))))

;; conformance_suite/PyDict_update.py
(check-judgment-holds* (⊢p ((import-from "__static__" (PyDict)) (define/assign x PyDict (dict (1 "foo") ("bar" 2))) (define/assign (subscript x "bar") "hello"))))
