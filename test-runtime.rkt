...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((import-from "__static__" ("PyDict")) (ann-assign "x" "PyDict" (dict (((con 1) (con "foo")) ((con "bar") (con 2))))) (try ((delete (subscript "x" (con "other")))) ((except-handler "KeyError" None (pass))) ((raise (call "Exception" ()))) ())))))))))
...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((class "C" () ((function-def "f" (("self" dynamic)) "int" ((return (con 1)))))) (function-def "x" (("c" "C")) dynamic ((assign ("x") (call (attribute "c" "f") ())) (aug-assign "x" + (call (attribute "c" "f") ())) (return "x"))) (function-def "main" (("x" dynamic)) dynamic ((assign ("c") (call "C" ())) (assert (compare (call "x" ("c")) ((== (con 2))))))) (expr (call "main" ("x")))))))))))

;; conformance_suite/edited_test_bind_boolop_type.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((import-from "typing" ("Any")) (class "C" () ((function-def "f" (("self" dynamic)) "bool" ((return (con #t)))) (function-def "g" (("self" dynamic)) "bool" ((return (con #f)))) (function-def "x" (("self" dynamic)) "bool" ((return (bool-op and ((call (attribute "self" "f") ()) (call (attribute "self" "g") ())))))) (function-def "y" (("self" dynamic)) "bool" ((return (bool-op or ((call (attribute "self" "f") ()) (call (attribute "self" "g") ())))))))) (function-def "main" () dynamic ((assign ("c") (call "C" ())) (assert (compare (call (attribute "c" "x") ()) ((== (con #f))))) (assert (compare (call (attribute "c" "y") ()) ((== (con #t))))))) (expr (call "main" ()))))))))))

;; conformance_suite/edited_test_call_function_unknown_ret_type.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((import-from "__future__" ("annotations")) (import-from "typing" ("Any")) (function-def "g" () "Any" ((return (con 42)))) (function-def "testfunc" () dynamic ((return (call "g" ())))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (con 42))))))) (expr (call "main" ("testfunc")))))))))))
...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "use" (("i" "object")) "object" ((return "i"))) (function-def "outer" (("x" "int") ("y" "str")) "object" ((function-def "inner" () (con None) ((expr (call "use" ("y"))))) (return (call "use" ("y"))))) (function-def "main" (("outer" dynamic)) dynamic ((assert (compare (call "outer" ((con 1) (con "hi"))) ((== (con "hi"))))))) (expr (call "main" ("outer")))))))))))

;; conformance_suite/edited_test_check_args_7.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "use" (("i" "object")) "object" ((return "i"))) (function-def "outer" (("x" "int") ("y" "int") ("z" "str")) "object" ((function-def "inner" () (con None) ((expr (call "use" ("x"))) (expr (call "use" ("y"))) (expr (call "use" ("z"))))) (return (tuple ((call "use" ("x")) (call "use" ("y")) (call "use" ("z"))))))) (function-def "main" (("outer" dynamic)) dynamic ((assert (compare (call "outer" ((con 3) (con 2) (con "hi"))) ((== (tuple ((con 3) (con 2) (con "hi"))))))))) (expr (call "main" ("outer")))))))))))
...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (try ((expr (call (subscript "CheckedDict" (tuple ("str" "str"))) ((con None))))) ((except-handler "Exception" None (pass))) ((raise (call "Exception" ((con "Should fail."))))) ())))))))))
...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (function-def "as_dyn" (("x" dynamic)) dynamic ((return "x"))) (assign ("x") (call (subscript "CheckedDict" (tuple ("str" "int"))) ((dict (((con "x") (con 2))))))) (try ((expr (call (attribute "x" "get") ((call "as_dyn" ((con 100))))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()) (try ((expr (call (attribute "x" "get") ((con "x") (call "as_dyn" ((con "abc"))))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ())))))))))

;; conformance_suite/edited_test_checked_dict_fromkeys_bad_types.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (try ((expr (call (attribute (subscript "CheckedDict" (tuple ("str" "int"))) "fromkeys") ((list ((con 2))) (con 42))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()) (try ((expr (call (attribute (subscript "CheckedDict" (tuple ("str" "int"))) "fromkeys") ((con "abc") (call "object" ()))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()) (try ((expr (call (attribute (subscript "CheckedDict" (tuple ("str" "int"))) "fromkeys") ((con "abc"))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ())))))))))
...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (assign ("x") (call (subscript "CheckedDict" (tuple ("str" "int"))) ((dict (((con "x") (con 2))))))) (assign ("y") (call (attribute "x" "pop") ((con "x")))) (assert (compare "y" ((== (con 2))))) (try ((expr (call (attribute "x" "pop") ((con "z"))))) ((except-handler "KeyError" None (pass))) ((raise (call "Exception" ()))) ())))))))))

;; conformance_suite/edited_test_checked_dict_popitem.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (assign ("x") (call (subscript "CheckedDict" (tuple ("str" "int"))) ((dict (((con "x") (con 2))))))) (assign ("y") (call (attribute "x" "popitem") ())) (assert (compare "y" ((== (tuple ((con "x") (con 2))))))) (try ((expr (call (attribute "x" "popitem") ()))) ((except-handler "KeyError" None (pass))) ((raise (call "Exception" ()))) ())))))))))
...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (function-def "as_dyn" (("x" dynamic)) dynamic ((return "x"))) (assign ("x") (call (subscript "CheckedDict" (tuple ("str" "int"))) ())) (try ((expr (call (attribute "x" "setdefault") ((con "abc") (call "as_dyn" ((con "abc"))))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()) (assert (compare "x" ((== (dict ()))))) (try ((expr (call (attribute "x" "setdefault") ((call "as_dyn" ((con 42))) (con 42))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()) (assert (compare "x" ((== (dict ())))))))))))))

;; conformance_suite/edited_test_checked_dict_types_enforced.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((import-from "typing" ("Any")) (import-from "__static__" ("CheckedDict")) (function-def "as_dyn" (("x" dynamic)) dynamic ((return "x"))) (ann-assign "x" "Any" (call (subscript "CheckedDict" (tuple ("str" "str"))) ())) (try ((assign ((subscript "x" (call "as_dyn" ((con 42))))) (con "abc"))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()) (assert (compare "x" ((== (dict ()))))) (try ((assign ((subscript "x" (con "abc"))) (call "as_dyn" ((con 42))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()) (assert (compare "x" ((== (dict ()))))) (assign ("x") (call (subscript "CheckedDict" (tuple ("str" "int"))) ())) (try ((assign ((subscript "x" (call "as_dyn" ((con 42))))) (con 42))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()) (assert (compare "x" ((== (dict ()))))) (try ((assign ((subscript "x" (con "abc"))) (call "as_dyn" ((con "abc"))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()) (assert (compare "x" ((== (dict ())))))))))))))
...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (assign ("x") (call (subscript "CheckedDict" (tuple ("str" "int"))) ())) (try ((expr (call (attribute "x" "update") ((dict (((con "x") (con "abc")))))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()) (assert (compare "x" ((== (dict ()))))) (try ((expr (call (attribute "x" "update") ((dict (((con "x") (con "abc")))))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()) (try ((expr (call (attribute "x" "update") ((dict (((con 24) (con 42)))))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()) (assert (compare "x" ((== (dict ())))))))))))))
...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((class "C" () ((function-def "f" (("self" dynamic)) dynamic ((return (con 1)))))) (function-def "x" (("c" "C")) dynamic ((assign ("x") (call (attribute "c" "f") ())) (aug-assign "x" + (call (attribute "c" "f") ())) (return "x"))) (assign ("a") (call "x" ((call "C" ())))) (class "D" ("C") ((function-def "f" (("self" dynamic)) dynamic ((return (con 2)))))) (assign ("b") (call "x" ((call "D" ())))) (function-def "main" (("a" dynamic) ("b" dynamic)) dynamic ((assert (compare "a" ((== (con 2))))) (assert (compare "b" ((== (con 4))))))) (expr (call "main" ("a" "b")))))))))))
...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((class "C" () ((function-def "f" (("self" dynamic)) dynamic ((return (con 1)))))) (function-def "x" (("c" "C")) dynamic ((assign ("x") (call (attribute "c" "f") ())) (aug-assign "x" + (call (attribute "c" "f") ())) (return "x"))) (function-def "main" (("x" dynamic)) dynamic ((assert (compare (call "x" ((call "C" ()))) ((== (con 2))))) (assign ((attribute "C" "f")) (lambda (("self" dynamic)) (con 42))) (assert (compare (call "x" ((call "C" ()))) ((== (con 84))))))) (expr (call "main" ("x")))))))))))

;; conformance_suite/edited_test_method_prologue_posonly.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "f" (("x" "int") ("y" "str")) dynamic ((return (con 42)))) (function-def "main" (("f" dynamic)) dynamic ((try ((expr (call "f" ((con 42) (con 42))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()))) (expr (call "main" ("f")))))))))))
...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "f" (("num" "int")) dynamic ((return (bin-op * "num" (list ((con 1) (con 2))))))) (class "MyInt" ("int") ((function-def "__mul__" (("self" dynamic) ("other" dynamic)) dynamic ((return (con "RESULT")))))) (function-def "main" () dynamic ((assert (compare (call "f" ((con 2))) ((== (list ((con 1) (con 2) (con 1) (con 2))))))) (assert (compare (call "f" ((call "MyInt" ((con 2))))) ((== (con "RESULT"))))))) (expr (call "main" ()))))))))))

;; conformance_suite/edited_test_seq_repeat_inexact_tuple.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((import-from "typing" ("Tuple")) (function-def "f" (("t" (subscript "Tuple" "int"))) dynamic ((return (bin-op * "t" (con 2))))) (class "MyTuple" ("tuple") ((function-def "__mul__" (("self" dynamic) ("other" dynamic)) dynamic ((return (con "RESULT")))))) (function-def "main" () dynamic ((assert (compare (call "f" ((tuple ((con 1) (con 2))))) ((== (tuple ((con 1) (con 2) (con 1) (con 2))))))) (assert (compare (call "f" ((call "MyTuple" ((tuple ((con 1) (con 2))))))) ((== (con "RESULT"))))))) (expr (call "main" ()))))))))))
...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((class "C" () ((function-def "__init__" (("self" dynamic) ("arg" dynamic)) (con None) ((ann-assign (attribute "self" "x") "str" "arg"))))) (try ((assign ("o") (call "C" ((con 42))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ())))))))))
...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((try ((for "i" (list ((con 2))) ((raise (call "Exception" ()))) ((assign ("i") (con 3))))) ((except-handler "Exception" None (pass))) () ()) (assert (compare "i" ((is (con 2)))))))))))))
...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((class "C" () ((function-def "f" (("self" dynamic)) "int" ((return (con 1)))))) (class "D" ("C") ((function-def "f" (("self" dynamic)) "int" ((return (con 2)))))) (class "E" ("C") (pass)) (function-def "x" (("c" "C")) dynamic ((assign ("x") (call (attribute "c" "f") ())) (aug-assign "x" + (call (attribute "c" "f") ())) (return "x"))) (function-def "main" (("x" dynamic)) dynamic ((assert (compare (call "x" ((call "C" ()))) ((== (con 2))))) (assert (compare (call "x" ((call "D" ()))) ((== (con 4))))) (assert (compare (call "x" ((call "E" ()))) ((== (con 2))))))) (expr (call "main" ("x")))))))))))
...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (function-def "testfunc" () dynamic ((assign ("x") (call (subscript "CheckedDict" (tuple ("int" "str"))) ((dict (((con 1) (con "abc"))))))) (expr (call (attribute "x" "__setitem__") ((con 2) (con "def")))) (return "x"))) (function-def "main" (("test" dynamic)) dynamic ((assign ("x") (call "test" ())) (assert (compare "x" ((== (dict (((con 1) (con "abc")) ((con 2) (con "def")))))))))) (expr (call "main" ("testfunc")))))))))))

;; conformance_suite/test_compile_dict_setitem_subscr.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (function-def "testfunc" () dynamic ((assign ("x") (call (subscript "CheckedDict" (tuple ("int" "str"))) ((dict (((con 1) (con "abc"))))))) (assign ((subscript "x" (con 2))) (con "def")) (return "x"))) (function-def "main" (("test" dynamic)) dynamic ((assign ("x") (call "test" ())) (assert (compare "x" ((== (dict (((con 1) (con "abc")) ((con 2) (con "def")))))))))) (expr (call "main" ("testfunc")))))))))))
...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("l") (dict (((con 1) (con "a")) ((con 2) (con "b")) ((con 3) (con "c")) ((con 4) (con "d"))))) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (con 4))))))) (expr (call "main" ("f")))))))))))

;; conformance_suite/test_fast_len_list.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("l") (list ((con 1) (con 2) (con 3) (con 4) (con 5) (con 6) (con 7)))) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (con 7))))))) (expr (call "main" ("f")))))))))))

;; conformance_suite/test_fast_len_list_subclass.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((class "mylist" ("list") ((function-def "__len__" (("self" dynamic)) dynamic ((return (con 1111)))))) (function-def "f" () dynamic ((assign ("l") (call "mylist" ((list ((con 1) (con 2)))))) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (con 1111))))))) (expr (call "main" ("f")))))))))))
...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "f" (("a" dynamic) ("b" dynamic)) dynamic ((assign ("l") (set ("a" "b"))) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ((con "a") (con "b"))) ((== (con 2))))))) (expr (call "main" ("f")))))))))))

;; conformance_suite/test_fast_len_set_subclass.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((class "myset" ("set") ((function-def "__len__" (("self" dynamic)) dynamic ((return (con 1111)))))) (function-def "f" () dynamic ((assign ("l") (call "myset" ((list ((con 1) (con 2)))))) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (con 1111))))))) (expr (call "main" ("f")))))))))))

;; conformance_suite/test_fast_len_set_subclass_2.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((class "myset" ("set") ((function-def "__len__" (("self" dynamic)) dynamic ((return (con 1111)))))) (function-def "f" (("x" dynamic) ("a" dynamic) ("b" dynamic)) dynamic ((assign ("l") (set ("a" "b"))) (if "x" ((assign ("l") (call "myset" ((list ("a" "b")))))) ()) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ((con #t) (con 1) (con 2))) ((== (con 1111))))))) (expr (call "main" ("f")))))))))))

;; conformance_suite/test_fast_len_str.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("l") (con "my str!")) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (con 7))))))) (expr (call "main" ("f")))))))))))

;; conformance_suite/test_fast_len_str_subclass.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((class "mystr" ("str") ((function-def "__len__" (("self" dynamic)) dynamic ((return (con 1111)))))) (function-def "f" () dynamic ((assign ("s") (call "mystr" ((con "a")))) (return (call "len" ("s"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (con 1111))))))) (expr (call "main" ("f")))))))))))

;; conformance_suite/test_fast_len_str_subclass_2.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((class "mystr" ("str") ((function-def "__len__" (("self" dynamic)) dynamic ((return (con 1111)))))) (function-def "f" (("x" dynamic)) dynamic ((assign ("s") (con "abc")) (if "x" ((assign ("s") (call "mystr" ((con "pqr"))))) ()) (return (call "len" ("s"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ((con #t))) ((== (con 1111))))) (assert (compare (call "f" ((con #f))) ((== (con 3))))))) (expr (call "main" ("f")))))))))))

;; conformance_suite/test_fast_len_str_unicode_chars.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("l") (con "🤣")) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (con 1))))))) (expr (call "main" ("f")))))))))))

;; conformance_suite/test_fast_len_tuple.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "f" (("a" dynamic) ("b" dynamic)) dynamic ((assign ("l") (tuple ("a" "b"))) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ((con "a") (con "b"))) ((== (con 2))))))) (expr (call "main" ("f")))))))))))

;; conformance_suite/test_fast_len_tuple_subclass.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((class "mytuple" ("tuple") ((function-def "__len__" (("self" dynamic)) dynamic ((return (con 1111)))))) (function-def "f" () dynamic ((assign ("l") (call "mytuple" ((list ((con 1) (con 2)))))) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (con 1111))))))) (expr (call "main" ("f")))))))))))

;; conformance_suite/test_fast_len_tuple_subclass_2.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((class "mytuple" ("tuple") ((function-def "__len__" (("self" dynamic)) dynamic ((return (con 1111)))))) (function-def "f" (("x" dynamic) ("a" dynamic) ("b" dynamic)) dynamic ((assign ("l") (tuple ("a" "b"))) (if "x" ((assign ("l") (call "mytuple" ((list ("a" "b")))))) ()) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ((con #t) (con 1) (con 2))) ((== (con 1111))))))) (expr (call "main" ("f")))))))))))
...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "func" () dynamic ((assign ("a") (con "a b c")) (return (call (attribute "a" "split") ())))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (list ((con "a") (con "b") (con "c"))))))))) (expr (call "main" ("func")))))))))))
...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "fib1" (("number" dynamic)) dynamic ((if (compare "number" ((<= (con 1)))) ((return "number")) ()) (return (bin-op + (call "fib" ((bin-op - "number" (con 1)))) (call "fib" ((bin-op - "number" (con 2)))))))) (function-def "fib" (("number" dynamic)) dynamic ((if (compare "number" ((<= (con 1)))) ((return "number")) ()) (return (bin-op + (call "fib1" ((bin-op - "number" (con 1)))) (call "fib1" ((bin-op - "number" (con 2)))))))) (function-def "main" (("fib" dynamic) ("fib1" dynamic)) dynamic ((assert (compare (call "fib" ((con 0))) ((== (con 0))))) (assert (compare (call "fib" ((con 4))) ((== (con 3))))))) (expr (call "main" ("fib" "fib1")))))))))))

;; conformance_suite/test_invoke_strict_module_pre_invoked.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "f" () dynamic ((return (con 42)))) (function-def "g" () dynamic ((return (call "f" ())))) (function-def "main" (("g" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (con 42))))) (assert (compare (call "g" ()) ((== (con 42))))))) (expr (call "main" ("g")))))))))))

;; conformance_suite/test_invoke_strict_module_recursive.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "fib" (("number" dynamic)) dynamic ((if (compare "number" ((<= (con 1)))) ((return "number")) ()) (return (bin-op + (call "fib" ((bin-op - "number" (con 1)))) (call "fib" ((bin-op - "number" (con 2)))))))) (function-def "main" (("fib" dynamic)) dynamic ((assert (compare (call "fib" ((con 4))) ((== (con 3))))))) (expr (call "main" ("fib")))))))))))
...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "f" (("x" "str")) dynamic ((return (con 42)))) (function-def "main" (("f" dynamic)) dynamic ((try ((expr (call "f" ((con 42))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()))) (expr (call "main" ("f")))))))))))

;; conformance_suite/test_method_prologue_2.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "f" (("x" dynamic) ("y" "str")) dynamic ((return (con 42)))) (function-def "main" (("f" dynamic)) dynamic ((try ((expr (call "f" ((con "abc") (con 42))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()))) (expr (call "main" ("f")))))))))))
...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "x" (("v" "str")) dynamic ((return (con "abc")))) (function-def "y" (("v" dynamic)) dynamic ((return (call "x" ("v"))))) (function-def "main" (("y" dynamic)) dynamic ((try ((expr (call "y" ((con 42))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()) (assert (compare (call "y" ((con "foo"))) ((== (con "abc"))))))) (expr (call "main" ("y")))))))))))
...
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((try ((ann-assign "x" "int" (con 42))) ((except-handler "Exception" None (pass))) (pass) (pass)) (assert (compare "x" ((is (con 42)))))))))))))

;; conformance_suite/try_except_catch_else_no_exn.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "f" () dynamic ((try (pass) ((except-handler "Exception" None ((return (con 2))))) ((return (con 3))) ()))) (assert (compare (call "f" ()) ((is (con 3)))))))))))))

;; conformance_suite/try_except_catch_else_some_exn.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "f" () dynamic ((try ((raise (call "Exception" ((con "foo"))))) ((except-handler "Exception" None ((return (con 2))))) ((return (con 3))) ()))) (assert (compare (call "f" ()) ((is (con 2)))))))))))))

;; conformance_suite/try_except_catch_final_no_exn.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "f" () dynamic ((try (pass) ((except-handler "Exception" None ((return (con 2))))) ((return (con 3))) ((return (con 42)))))) (assert (compare (call "f" ()) ((is (con 42)))))))))))))

;; conformance_suite/try_except_catch_final_some_exn.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "f" () dynamic ((try ((raise (call "Exception" ((con "foo"))))) ((except-handler "Exception" None ((return (con 2))))) ((return (con 3))) ((return (con 42)))))) (assert (compare (call "f" ()) ((is (con 42)))))))))))))

;; conformance_suite/try_except_catch_same_class.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((function-def "f" () dynamic ((try ((raise (call "Exception" ((con "foo"))))) ((except-handler "Exception" None ((return (con 42))))) () ()))) (assert (compare (call "f" ()) ((is (con 42)))))))))))))

;; conformance_suite/try_except_catch_sub_class.py
(check-not-exn (lambda () (test-match SP-dynamics (terminate) (term (calc (compile-program (desugar-program ((class "C" ("Exception") (pass)) (function-def "f" () dynamic ((try ((raise (call "C" ((con "foo"))))) ((except-handler "Exception" None ((return (con 42))))) () ()))) (assert (compare (call "f" ()) ((is (con 42)))))))))))))
