...
(test-match SP-core program (term (desugar-program ((import-from "typing" ("List")) (function-def "foo" () (subscript "List" "int") ((assign ("a") (list ((con 1) (con 2) (con 3) (con 4)))) (return (list-comp "x" (("x" "a" ((compare "x" ((> (con 2)))))))))))))))
...
(test-match SP-core program (term (desugar-program ((import-from "typing" ("List")) (function-def "foo" () (subscript "List" "int") ((assign ("a") (list ((con 1) (con 2) (con 3) (con 4)))) (assign ("b") (list ((con 1) (con 2)))) (return (list-comp (bin-op * "x" "y") (("x" "a" ()) ("y" "b" ((compare "x" ((> (con 2)))))))))))))))
...
(test-match SP-core program (term (desugar-program ((import-from "typing" ("Iterable")) (function-def "f" (("l" (subscript "Iterable" "int"))) dynamic ((for "x" (call "sorted" ("l")) (pass) ())))))))
