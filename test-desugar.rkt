...
(test-match SP-core program (term (desugar-program ((import-from "typing" ("Optional")) (function-def "f" (("x" (subscript "Optional" "str"))) "str" ((while (con #t) ((if (compare "x" ((is (con None)))) (break) ()) (return "x")) ())))))))
...
(test-match SP-core program (term (desugar-program ((import-from "typing" ("Optional")) (function-def "f" (("x" (subscript "Optional" "str"))) "str" ((while (con #t) ((if (compare "x" ((is (con None)))) (continue) ()) (return "x")) ())))))))
...
(test-match SP-core program (term (desugar-program ((import-from "typing" ("Optional")) (function-def "f" (("x" (subscript "Optional" "int"))) "int" ((while (compare "x" ((is (con None)))) (break) ()) (return "x")))))))

;; conformance_suite/test_narrow_while_break_if.py
(test-match SP-core program (term (desugar-program ((import-from "typing" ("Optional")) (function-def "f" (("x" (subscript "Optional" "int"))) "int" ((while (con #t) ((if (compare "x" ((is (con None)))) (break) ()) (return "x")) ())))))))

;; conformance_suite/test_narrow_while_continue_if.py
(test-match SP-core program (term (desugar-program ((import-from "typing" ("Optional")) (function-def "f" (("x" (subscript "Optional" "int"))) "int" ((while (con #t) ((if (compare "x" ((is (con None)))) (continue) ()) (return "x")) ())))))))

;; conformance_suite/test_narrow_while_if_break_else_return.py
(test-match SP-core program (term (desugar-program ((import-from "typing" ("Optional")) (function-def "f" (("x" (subscript "Optional" "int")) ("y" "int")) "int" ((while (compare "x" ((is (con None)))) ((if (compare "y" ((> (con 0)))) (break) ((return (con 42))))) ()) (return "x")))))))
