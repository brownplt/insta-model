...
(test-match SP-core program (term (desugar-program ((class "C" ("int") (pass)) (ann-assign "x" "C" (call "C" ((con 42)))) (ann-assign "y" "int" "x")))))

;; conformance_suite/subclass_builtin_generic.py
(test-match SP-core program (term (desugar-program ((import-from "__static__" ("CheckedDict")) (class "C" ((subscript "CheckedDict" (tuple ("str" "int")))) (pass)) (ann-assign "x" "C" (call "C" ((dict ())))) (ann-assign "y" (subscript "CheckedDict" (tuple ("str" "int"))) "x")))))
