...
(test-match SP-core program (term (desugar-program ((function-def "make_C1" () dynamic ((class "C" () ((ann-assign "x" "str"))) (return "C"))) (assign "C1" (call "make_C1" ())) (class "C2" ("C1") ((ann-assign "y" "int"))) (assign "c" (call "C2" ())) (assign (attribute "c" "abc") (con "foo")) (assert (compare (attribute "c" "abc") ((== (con "foo")))))))))
...
(test-match SP-core program (term (desugar-program ((class "C" () (pass)) (assert (compare (attribute "C" "__slots__") ((== (tuple ())))))))))

;; conformance_suite/slots_contain_object_fields_but_not_class_fields.py
(test-match SP-core program (term (desugar-program ((import-from "typing" ("ClassVar")) (class "C" () ((ann-assign "x" (subscript "ClassVar" "int") (con 2)) (ann-assign "y" "str"))) (assert (compare (attribute "C" "__slots__") ((== (tuple ((con "y")))))))))))

;; conformance_suite/slots_do_not_accumulate.py
(test-match SP-core program (term (desugar-program ((class "C1" () ((ann-assign "x" "str"))) (class "C2" ("C1") ((ann-assign "y" "int"))) (assert (compare (attribute "C2" "__slots__") ((== (tuple ((con "y")))))))))))

;; conformance_suite/slots_do_not_contain_methods.py
(test-match SP-core program (term (desugar-program ((class "C" () ((function-def "mth1" (("self" dynamic)) dynamic (pass)))) (assert (compare (attribute "C" "__slots__") ((== (tuple ())))))))))
