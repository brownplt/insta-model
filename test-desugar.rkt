...
(test-match SP-core program (term (desugar-program ((class "C1" () ((ann-assign "x" "str"))) (class "C2" ("C1") ((ann-assign "y" "int"))) (assign "c" (call "C2" ())) (assign (attribute "c" "x") (con "foo")) (assert (compare (attribute "c" "x") ((== (con "foo")))))))))
...
(test-match SP-core program (term (desugar-program ((import-from "typing" ("Final")) (ann-assign "X" "str" (con "omg")) (function-def "f" () "str" ((return (subscript "X" (con 1)))))))))
...
(test-match SP-core program (term (desugar-program ((class "A" () ((function-def "m" (("self" dynamic) ("x" "str")) "int" ((return (con 42)))))) (class "B" ("A") ((function-def "m" (("self" dynamic) ("y" "str")) "int" ((return (con 0))))))))))
