...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (function-def "testfunc" () dynamic ((assign ("x") (call (subscript "CheckedDict" (tuple ("int" "str"))) ((dict (((con 1) (con "abc"))))))) (expr (call (attribute "x" "__setitem__") ((con 2) (con "def")))) (return "x"))))))))

;; conformance_suite/test_compile_dict_setitem_subscr.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (function-def "testfunc" () dynamic ((assign ("x") (call (subscript "CheckedDict" (tuple ("int" "str"))) ((dict (((con 1) (con "abc"))))))) (assign ((subscript "x" (con 2))) (con "def")) (return "x"))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("List")) (function-def "f" (("n" "int")) "List" ((assign ("acc") (list ())) (assign ("l") (list-comp "i" (("i" (call "range" ("n")) ())))) (for "i" "l" ((expr (call (attribute "acc" "append") ((bin-op + "i" (con 1)))))) ()) (return "acc"))))))))

;; conformance_suite/test_for_iter_sequence_orelse.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("List")) (function-def "f" (("n" "int")) "List" ((assign ("acc") (list ())) (assign ("l") (list-comp "i" (("i" (call "range" ("n")) ())))) (for "i" "l" ((expr (call (attribute "acc" "append") ((bin-op + "i" (con 1)))))) ((expr (call (attribute "acc" "append") ((con 999)))))) (return "acc"))))))))

;; conformance_suite/test_for_iter_sequence_return.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("List")) (function-def "f" (("n" "int")) "List" ((assign ("acc") (list ())) (assign ("l") (list-comp "i" (("i" (call "range" ("n")) ())))) (for "i" "l" ((if (compare "i" ((== (con 3)))) ((return "acc")) ()) (expr (call (attribute "acc" "append") ((bin-op + "i" (con 1)))))) ()) (return "acc"))))))))

;; conformance_suite/test_for_iter_tuple.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("List")) (function-def "f" (("n" "int")) "List" ((assign ("acc") (list ())) (assign ("l") (call "tuple" ((list-comp "i" (("i" (call "range" ("n")) ())))))) (for "i" "l" ((expr (call (attribute "acc" "append") ((bin-op + "i" (con 1)))))) ()) (return "acc"))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("l" "list")) dynamic ((assign ("x") (con 2)) (return (list-comp (bin-op + "x" "y") (("y" "l" ())))))) (function-def "g" () dynamic ((return (call "f" ((list ((con 1) (con 2) (con 3)))))))))))))

;; conformance_suite/test_invoke_with_cell_arg.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("l" "list") ("x" "int")) dynamic ((return (list-comp (bin-op + "x" "y") (("y" "l" ())))))) (function-def "g" () dynamic ((return (call "f" ((list ((con 1) (con 2) (con 3))) (con 2)))))))))))

;; conformance_suite/test_list_comprehension_with_if.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("List")) (function-def "foo" () (subscript "List" "int") ((assign ("a") (list ((con 1) (con 2) (con 3) (con 4)))) (return (list-comp "x" (("x" "a" ((compare "x" ((> (con 2))))))))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("List")) (function-def "f" (("n" "int")) "List" ((assign ("acc") (list ())) (assign ("l") (list-comp "i" (("i" (call "range" ("n")) ())))) (for "i" "l" ((for "j" "l" ((expr (call (attribute "acc" "append") ((bin-op + "i" "j"))))) ())) ()) (return "acc"))))))))

;; conformance_suite/test_nested_for_iter_sequence_return.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("List")) (function-def "f" (("n" "int")) "List" ((assign ("acc") (list ())) (assign ("l") (list-comp "i" (("i" (call "range" ("n")) ())))) (for "i" "l" ((for "j" "l" ((if (compare "j" ((== (con 1)))) ((return "acc")) ()) (expr (call (attribute "acc" "append") ((bin-op + "i" "j"))))) ())) ()) (return "acc"))))))))

;; conformance_suite/test_nested_list_comprehensions_with_if.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("List")) (function-def "foo" () (subscript "List" "int") ((assign ("a") (list ((con 1) (con 2) (con 3) (con 4)))) (assign ("b") (list ((con 1) (con 2)))) (return (list-comp (bin-op * "x" "y") (("x" "a" ()) ("y" "b" ((compare "x" ((> (con 2))))))))))))))))
