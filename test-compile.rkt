...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("Any")) (class "C" () ((function-def "f" (("self" dynamic)) "bool" ((return (con #t)))) (function-def "g" (("self" dynamic)) "bool" ((return (con #f)))) (function-def "x" (("self" dynamic)) "bool" ((return (bool-op and ((call (attribute "self" "f") ()) (call (attribute "self" "g") ())))))) (function-def "y" (("self" dynamic)) "bool" ((return (bool-op or ((call (attribute "self" "f") ()) (call (attribute "self" "g") ())))))))) (assert (compare (call (attribute "c" "y") ()) ((== (con #t))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (function-def "testfunc" () dynamic ((ann-assign "x" (subscript "CheckedDict" (tuple ("int" "str"))) (dict ())) (return "x"))) (assert (compare (call "type" ((call "f" ()))) ((== (subscript "chkdict" (tuple ("int" "str"))))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (class "B" () (pass)) (function-def "testfunc" () dynamic ((ann-assign "x" (subscript "CheckedDict" (tuple ("B" "int"))) (dict (((call "B" ()) (con 42))))) (return "x"))) (assert (compare (call "type" ((call "test" ()))) ((== (subscript "chkdict" (tuple ("B" "int"))))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("a" "int") ("b" "int")) "int" ((return (call "max" ("a" "b"))))) (assert (compare (call "f" ((con 3) (con 1))) ((== (con 3))))))))))

;; conformance_suite/test_max_stability.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("a" "int") ("b" "int")) "int" ((return (call "max" ("a" "b"))))) (assert (compare (call "id" ((call "f" ("q" "p")))) ((== (call "id" ("q")))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("a" "int") ("b" "int")) "int" ((return (call "min" ("a" "b"))))) (assert (compare (call "f" ((con 3) (con 1))) ((== (con 1))))))))))

;; conformance_suite/test_min_stability.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("a" "int") ("b" "int")) "int" ((return (call "min" ("a" "b"))))) (assert (compare (call "id" ((call "f" ("q" "p")))) ((== (call "id" ("q")))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () "int" ((assign ("l") (bin-op * (list ((con 1) (con 2) (con 3))) (con 2))) (return (call "len" ("l"))))) (assert (compare (call (attribute "mod" "f") ()) ((== (con 6))))))))))

;; conformance_suite/test_multiply_list_exact_by_int_reverse.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () "int" ((assign ("l") (bin-op * (con 2) (list ((con 1) (con 2) (con 3))))) (return (call "len" ("l"))))) (assert (compare (call (attribute "mod" "f") ()) ((== (con 6))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict")) (function-def "f" (("d" (subscript "PyDict" (tuple ("str" "int"))))) "str" ((return (subscript "d" (con 3))))) (assert (compare (call (attribute "mod" "f") ((dict (((con 3) (con "foo")))))) ((== (con "foo"))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("Optional")) (function-def "f" (("s" (subscript "Optional" "str"))) "str" ((return (bool-op or ("s" (con "hi")))))) (assert (compare (call "f" ((con None))) ((== (con "hi"))))))))))

;; conformance_suite/test_refine_or_expression_with_multiple_optionals.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("Optional")) (function-def "f" (("s1" (subscript "Optional" "str")) ("s2" (subscript "Optional" "str"))) "str" ((return (bool-op or ("s1" "s2" (con "hi")))))) (assert (compare (call "f" ((con None) (con None))) ((== (con "hi"))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("List")) (function-def "f" (("l" (subscript "List" "int"))) dynamic ((return (bin-op * "l" (con 2))))) (assert (compare (call (attribute "mod" "f") ((call "MyList" ((list ((con 1) (con 2))))))) ((== (con "RESULT"))))))))))

;; conformance_suite/test_seq_repeat_inexact_num.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("num" "int")) dynamic ((return (bin-op * "num" (list ((con 1) (con 2))))))) (assert (compare (call (attribute "mod" "f") ((call "MyInt" ((con 2))))) ((== (con "RESULT"))))))))))

;; conformance_suite/test_seq_repeat_inexact_tuple.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("Tuple")) (function-def "f" (("t" (subscript "Tuple" "int"))) dynamic ((return (bin-op * "t" (con 2))))) (assert (compare (call (attribute "mod" "f") ((call "MyTuple" ((tuple ((con 1) (con 2))))))) ((== (con "RESULT"))))))))))

;; conformance_suite/test_seq_repeat_list.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("l") (list ((con 1) (con 2)))) (return (bin-op * "l" (con 2))))) (assert (compare (call (attribute "mod" "f") ()) ((== (list ((con 1) (con 2) (con 1) (con 2))))))))))))

;; conformance_suite/test_seq_repeat_list_reversed.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("l") (list ((con 1) (con 2)))) (return (bin-op * (con 2) "l")))) (assert (compare (call (attribute "mod" "f") ()) ((== (list ((con 1) (con 2) (con 1) (con 2))))))))))))

;; conformance_suite/test_seq_repeat_tuple.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("t") (tuple ((con 1) (con 2)))) (return (bin-op * "t" (con 2))))) (assert (compare (call (attribute "mod" "f") ()) ((== (tuple ((con 1) (con 2) (con 1) (con 2))))))))))))

;; conformance_suite/test_seq_repeat_tuple_reversed.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("t") (tuple ((con 1) (con 2)))) (return (bin-op * (con 2) "t")))) (assert (compare (call (attribute "mod" "f") ()) ((== (tuple ((con 1) (con 2) (con 1) (con 2))))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((assign ("x") (lambda (("x" dynamic)) "x")) (assign ("a") (call "x" ((con "hi")))) (assert (compare (attribute "mod" "a") ((== (con "hi"))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((assign ("x") (con 0)) (if "x" (pass) ((function-def "f" () dynamic ((return (con 42)))))) (assert (compare (call (attribute "mod" "f") ()) ((== (con 42))))))))))
