...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict" "CheckedDict")) (ann-assign "x" (subscript "CheckedDict" (tuple ("str" "int"))) (call (subscript "CheckedDict" (tuple ("str" "int"))) ((dict (((con "foo") (con 1))))))) (ann-assign "y" "int" (subscript "x" (con "foo"))) (assert (compare "y" ((== (con 1))))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict")) (ann-assign "x" "PyDict" (dict (((con 1) (con "foo")) ((con "bar") (con 2))))) (try ((delete (subscript "x" (con "other")))) ((except-handler "KeyError" None (pass))) ((raise (call "Exception" ()))) ()))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict")) (ann-assign "x" "PyDict" (dict (((con 1) (con "foo")) ((con "bar") (con 2))))) (delete (subscript "x" (con "bar"))) (try ((expr (subscript "x" (con "bar")))) ((except-handler "KeyError" None (pass))) ((raise (call "Exception" ()))) ()))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict")) (ann-assign "x" "PyDict" (dict (((con 1) (con "foo")) ((con "bar") (con 2))))) (try ((expr (subscript "x" (con "other")))) ((except-handler "KeyError" None (pass))) ((raise (call "Exception" ()))) ()))))))))

;; conformance_suite/PyDict_lookup_good_key.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict")) (ann-assign "x" "PyDict" (dict (((con 1) (con "foo")) ((con "bar") (con 2))))) (assert (compare (subscript "x" (con "bar")) ((== (con 2))))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((class "C" () ((function-def "f" (("self" dynamic)) "int" ((return (con 1)))))) (function-def "x" (("c" "C")) dynamic ((assign ("x") (call (attribute "c" "f") ())) (aug-assign "x" + (call (attribute "c" "f") ())) (return "x"))) (function-def "main" (("x" dynamic)) dynamic ((assign ("c") (call "C" ())) (assert (compare (call "x" ("c")) ((== (con 2))))))) (expr (call "main" ("x"))))))))))

;; conformance_suite/edited_test_assign_dynamic_to_dynamic.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("Any")) (function-def "f" (("C" dynamic)) dynamic ((ann-assign "x" "Any" (call "C" ())))))))))))

;; conformance_suite/edited_test_assign_num_to_dynamic.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("Any")) (function-def "f" () dynamic ((ann-assign "x" "Any" (con 42)))))))))))

;; conformance_suite/edited_test_assign_try_except_redeclare_unknown_type.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("Any")) (function-def "testfunc" () dynamic ((ann-assign "e" "int") (try (pass) ((except-handler "Any" "e" (pass))) () ()) (return (con 42)))))))))))

;; conformance_suite/edited_test_bind_boolop_type.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("Any")) (class "C" () ((function-def "f" (("self" dynamic)) "bool" ((return (con #t)))) (function-def "g" (("self" dynamic)) "bool" ((return (con #f)))) (function-def "x" (("self" dynamic)) "bool" ((return (bool-op and ((call (attribute "self" "f") ()) (call (attribute "self" "g") ())))))) (function-def "y" (("self" dynamic)) "bool" ((return (bool-op or ((call (attribute "self" "f") ()) (call (attribute "self" "g") ())))))))) (function-def "main" () dynamic ((assign ("c") (call "C" ())) (assert (compare (call (attribute "c" "x") ()) ((== (con #f))))) (assert (compare (call (attribute "c" "y") ()) ((== (con #t))))))) (expr (call "main" ())))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "use" (("i" "object")) "object" ((return "i"))) (function-def "outer" (("x" "int") ("y" "int") ("z" "str")) "object" ((function-def "inner" () (con None) ((expr (call "use" ("x"))) (expr (call "use" ("y"))) (expr (call "use" ("z"))))) (return (tuple ((call "use" ("x")) (call "use" ("y")) (call "use" ("z"))))))) (function-def "main" (("outer" dynamic)) dynamic ((assert (compare (call "outer" ((con 3) (con 2) (con "hi"))) ((== (tuple ((con 3) (con 2) (con "hi"))))))))) (expr (call "main" ("outer"))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (try ((expr (call (subscript "CheckedDict" (tuple ("str" "str"))) ((con None))))) ((except-handler "Exception" None (pass))) ((raise (call "Exception" ((con "Should fail."))))) ()))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (function-def "as_dyn" (("x" dynamic)) dynamic ((return "x"))) (assign ("x") (call (subscript "CheckedDict" (tuple ("str" "int"))) ((dict (((con "x") (con 2))))))) (try ((expr (call (attribute "x" "get") ((call "as_dyn" ((con 100))))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()) (try ((expr (call (attribute "x" "get") ((con "x") (call "as_dyn" ((con "abc"))))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()))))))))

;; conformance_suite/edited_test_checked_dict_fromkeys_bad_types.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (try ((expr (call (attribute (subscript "CheckedDict" (tuple ("str" "int"))) "fromkeys") ((list ((con 2))) (con 42))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()) (try ((expr (call (attribute (subscript "CheckedDict" (tuple ("str" "int"))) "fromkeys") ((con "abc") (call "object" ()))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()) (try ((expr (call (attribute (subscript "CheckedDict" (tuple ("str" "int"))) "fromkeys") ((con "abc"))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (assign ("x") (call (subscript "CheckedDict" (tuple ("str" "int"))) ((dict (((con "x") (con 2))))))) (assign ("y") (call (attribute "x" "pop") ((con "x")))) (assert (compare "y" ((== (con 2))))) (try ((expr (call (attribute "x" "pop") ((con "z"))))) ((except-handler "KeyError" None (pass))) ((raise (call "Exception" ()))) ()))))))))

;; conformance_suite/edited_test_checked_dict_popitem.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (assign ("x") (call (subscript "CheckedDict" (tuple ("str" "int"))) ((dict (((con "x") (con 2))))))) (assign ("y") (call (attribute "x" "popitem") ())) (assert (compare "y" ((== (tuple ((con "x") (con 2))))))) (try ((expr (call (attribute "x" "popitem") ()))) ((except-handler "KeyError" None (pass))) ((raise (call "Exception" ()))) ()))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (assign ("x") (call (subscript "CheckedDict" (tuple ("str" "int"))) ())) (try ((expr (call (attribute "x" "update") ((dict (((con "x") (con "abc")))))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()) (assert (compare "x" ((== (dict ()))))) (try ((expr (call (attribute "x" "update") ((dict (((con "x") (con "abc")))))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()) (try ((expr (call (attribute "x" "update") ((dict (((con 24) (con 42)))))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()) (assert (compare "x" ((== (dict ()))))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((class "C" () ((function-def "f" (("self" dynamic)) dynamic ((return (con 1)))))) (function-def "x" (("c" "C")) dynamic ((assign ("x") (call (attribute "c" "f") ())) (aug-assign "x" + (call (attribute "c" "f") ())) (return "x"))) (assign ("a") (call "x" ((call "C" ())))) (class "D" ("C") ((function-def "f" (("self" dynamic)) dynamic ((return (con 2)))))) (assign ("b") (call "x" ((call "D" ())))) (function-def "main" (("a" dynamic) ("b" dynamic)) dynamic ((assert (compare "a" ((== (con 2))))) (assert (compare "b" ((== (con 4))))))) (expr (call "main" ("a" "b"))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((class "C" () ((function-def "f" (("self" dynamic)) dynamic ((return (con 1)))))) (function-def "x" (("c" "C")) dynamic ((assign ("x") (call (attribute "c" "f") ())) (aug-assign "x" + (call (attribute "c" "f") ())) (return "x"))) (function-def "main" (("x" dynamic)) dynamic ((assert (compare (call "x" ((call "C" ()))) ((== (con 2))))) (assign ((attribute "C" "f")) (lambda (("self" dynamic)) (con 42))) (assert (compare (call "x" ((call "C" ()))) ((== (con 84))))))) (expr (call "main" ("x"))))))))))

;; conformance_suite/edited_test_method_prologue_posonly.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("x" "int") ("y" "str")) dynamic ((return (con 42)))) (function-def "main" (("f" dynamic)) dynamic ((try ((expr (call "f" ((con 42) (con 42))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()))) (expr (call "main" ("f"))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("num" "int")) dynamic ((return (bin-op * "num" (list ((con 1) (con 2))))))) (class "MyInt" ("int") ((function-def "__mul__" (("self" dynamic) ("other" dynamic)) dynamic ((return (con "RESULT")))))) (function-def "main" () dynamic ((assert (compare (call "f" ((con 2))) ((== (list ((con 1) (con 2) (con 1) (con 2))))))) (assert (compare (call "f" ((call "MyInt" ((con 2))))) ((== (con "RESULT"))))))) (expr (call "main" ())))))))))

;; conformance_suite/edited_test_seq_repeat_inexact_tuple.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("Tuple")) (function-def "f" (("t" (subscript "Tuple" "int"))) dynamic ((return (bin-op * "t" (con 2))))) (class "MyTuple" ("tuple") ((function-def "__mul__" (("self" dynamic) ("other" dynamic)) dynamic ((return (con "RESULT")))))) (function-def "main" () dynamic ((assert (compare (call "f" ((tuple ((con 1) (con 2))))) ((== (tuple ((con 1) (con 2) (con 1) (con 2))))))) (assert (compare (call "f" ((call "MyTuple" ((tuple ((con 1) (con 2))))))) ((== (con "RESULT"))))))) (expr (call "main" ())))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((class "C" () ((function-def "__init__" (("self" dynamic) ("value" "str")) dynamic ((ann-assign (attribute "self" "x") "str" "value"))))) (function-def "main" () dynamic ((assign ("a") (call "C" ((con "abc")))) (delete (attribute "a" "x")) (try ((expr (attribute "a" "x"))) ((except-handler "AttributeError" None (pass))) ((raise (call "Exception" ()))) ()))) (expr (call "main" ())))))))))

;; conformance_suite/edited_test_untyped_attr.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((return (con 42)))) (assign ("x") (call "f" ())) (assign ("y") (attribute "x" "load")) (assign ((attribute "x" "store")) (con 42)) (delete (attribute "x" "delete")))))))))

;; conformance_suite/edited_test_verify_arg_unknown_type.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("Any")) (function-def "x" (("x" "Any")) dynamic ((function-def "f" () dynamic ((return (con 42)))) (assign ("b") (call "f" ())) (return "b"))) (expr (call "x" ((con "abc")))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((class "C" () ((function-def "__init__" (("self" dynamic) ("arg" dynamic)) (con None) ((ann-assign (attribute "self" "x") "str" "arg"))))) (try ((assign ("o") (call "C" ((con 42))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()))))))))

;; conformance_suite/field_update.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((class "C" () ((function-def "__init__" (("self" dynamic) ("arg" dynamic)) (con None) ((ann-assign (attribute "self" "x") "str" "arg"))))) (assign ("o") (call "C" ((con "foo")))) (try ((function-def "dyn_int" () dynamic ((return (con 42)))) (assign ((attribute "o" "x")) (call "dyn_int" ()))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((try ((for "i" (list ((con 2))) ((raise (call "Exception" ()))) ((assign ("i") (con 3))))) ((except-handler "Exception" None (pass))) () ()) (assert (compare "i" ((is (con 2))))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((class "C" () ((function-def "__init__" (("self" dynamic) ("arg" dynamic)) (con None) ((ann-assign (attribute "self" "x") "str" "arg"))))) (assign ("o") (call "C" ((con "foo")))) (assert (compare (attribute "o" "x") ((== (con "foo"))))))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((class "C" () ((function-def "m" (("self" dynamic) ("x" "int")) dynamic ((return (con None)))))) (expr (call (attribute (call "C" ()) "m") ((con "foo"))))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((class "C" () ((ann-assign "x" "int"))) (class "D" ("C") ((ann-assign "x" "str")))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((ann-assign "x" "int" (con 2)) (class "x" () (pass))))))))

;; conformance_suite/redeclare_var_with_def.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((ann-assign "x" "int" (con 2)) (function-def "x" () dynamic (pass))))))))

;; conformance_suite/redeclare_var_with_var_dyn_to_type.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((assign ("x") (con 2)) (ann-assign "x" "int" (con 3))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((class "C" () ((function-def "f" (("self" dynamic)) "int" ((return (con 1)))))) (class "D" ("C") ((function-def "f" (("self" dynamic)) "int" ((return (con 2)))))) (class "E" ("C") (pass)) (function-def "x" (("c" "C")) dynamic ((assign ("x") (call (attribute "c" "f") ())) (aug-assign "x" + (call (attribute "c" "f") ())) (return "x"))) (function-def "main" (("x" dynamic)) dynamic ((assert (compare (call "x" ((call "C" ()))) ((== (con 2))))) (assert (compare (call "x" ((call "D" ()))) ((== (con 4))))) (assert (compare (call "x" ((call "E" ()))) ((== (con 2))))))) (expr (call "main" ("x"))))))))))

;; conformance_suite/test_assert_narrowing_debug.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "foo" (("x" (bin-op bit-or "int" "str"))) "int" ((assert (call "isinstance" ("x" "int"))) (return (bin-op + "x" (con 1))))) (function-def "main" (("foo" dynamic)) dynamic ((assert (compare (call "foo" ((con 1))) ((== (con 2))))) (try ((expr (call "foo" ((con "a"))))) ((except-handler "AssertionError" None (pass))) ((raise (call "Exception" ()))) ()))) (expr (call "main" ("foo"))))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((import-from "typing" ("Optional")) (function-def "f" () dynamic ((ann-assign "x" "Optional" (con 42))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "testfunc" () dynamic ((ann-assign "e" "int") (try (pass) ((except-handler "Exception" "e" (pass))) () ()) (return (con 42)))))))))))

;; conformance_suite/test_assign_try_except_typing.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "testfunc" () dynamic ((try (pass) ((except-handler "Exception" "e" (pass))) () ()) (return (con 42)))))))))))

;; conformance_suite/test_assign_try_except_typing_narrowed.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((class "E" ("Exception") (pass)) (function-def "testfunc" () dynamic ((ann-assign "e" "Exception") (try (pass) ((except-handler "E" "e" (pass))) () ()) (return (con 42)))))))))))

;; conformance_suite/test_assign_try_except_typing_predeclared.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "testfunc" () dynamic ((ann-assign "e" "Exception") (try (pass) ((except-handler "Exception" "e" (pass))) () ()) (return (con 42)))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((class "C" () ((function-def "__init__" (("self" dynamic)) dynamic ((assign ((attribute "self" "x")) (con 1)))))) (function-def "f" (("a" "C")) dynamic ((aug-assign (attribute "a" "x") + (con 1)))))))))))

;; conformance_suite/test_aug_assign.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("l" dynamic)) dynamic ((aug-assign (subscript "l" (con 0)) + (con 1)))) (function-def "main" (("f" dynamic)) dynamic ((assign ("l") (list ((con 1)))) (expr (call "f" ("l"))) (assert (compare (subscript "l" (con 0)) ((== (con 2))))))) (expr (call "main" ("f"))))))))))

;; conformance_suite/test_augassign_inexact.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "something" () dynamic ((return (con 3)))) (function-def "t" () dynamic ((ann-assign "a" "int" (call "something" ())) (assign ("b") (con 0)) (aug-assign "b" + "a") (return "b"))) (function-def "main" (("t" dynamic)) dynamic ((assert (compare (call "t" ()) ((== (con 3))))))) (expr (call "main" ("t"))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("pydict")) (class "B" () (pass)) (class "D" ("B") (pass)) (function-def "testfunc" () dynamic ((ann-assign "x" "pydict" (dict (((call "B" ()) (con 42)) ((call "D" ()) (con 42))))) (return "x"))) (function-def "main" (("test" dynamic)) dynamic ((assert (compare (call "type" ((call "test" ()))) ((== "dict")))))) (expr (call "main" ("testfunc"))))))))))

;; conformance_suite/test_compile_checked_dict_explicit_dict_as_dict.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("pydict")) (class "B" () (pass)) (class "D" ("B") (pass)) (function-def "testfunc" () dynamic ((ann-assign "x" "dict" (dict (((call "B" ()) (con 42)) ((call "D" ()) (con 42))))) (return "x"))) (function-def "main" (("test" dynamic)) dynamic ((assert (compare (call "type" ((call "test" ()))) ((== "dict")))))) (expr (call "main" ("testfunc"))))))))))

;; conformance_suite/test_compile_checked_dict_len.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (function-def "testfunc" () dynamic ((assign ("x") (call (subscript "CheckedDict" (tuple ("int" "str"))) ((dict (((con 1) (con "abc"))))))) (return (call "len" ("x"))))) (function-def "main" (("test" dynamic)) dynamic ((assert (compare (call "test" ()) ((== (con 1))))))) (expr (call "main" ("testfunc"))))))))))

;; conformance_suite/test_compile_checked_dict_opt_out_by_default.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((class "B" () (pass)) (class "D" ("B") (pass)) (function-def "testfunc" () dynamic ((assign ("x") (dict (((call "B" ()) (con 42)) ((call "D" ()) (con 42))))) (return "x"))) (function-def "main" (("test" dynamic) ("B" dynamic)) dynamic ((assert (compare (call "type" ((call "test" ()))) ((== "dict")))))) (expr (call "main" ("testfunc" "B"))))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (class "B" () (pass)) (function-def "testfunc" () dynamic ((ann-assign "x" (subscript "CheckedDict" (tuple ("B" "int"))) (dict (((call "B" ()) (con "hi"))))) (return "x")))))))))

;; conformance_suite/test_compile_dict_get_typed.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (function-def "testfunc" () dynamic ((assign ("x") (call (subscript "CheckedDict" (tuple ("int" "str"))) ((dict (((con 42) (con "abc"))))))) (ann-assign "y" (bin-op bit-or "str" (con None)) (call (attribute "x" "get") ((con 42)))))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (function-def "testfunc" () dynamic ((assign ("x") (call (subscript "CheckedDict" (tuple ("int" "str"))) ((dict (((con 1) (con "abc"))))))) (expr (call (attribute "x" "__setitem__") ((con 2) (con "def")))) (return "x"))) (function-def "main" (("test" dynamic)) dynamic ((assign ("x") (call "test" ())) (assert (compare "x" ((== (dict (((con 1) (con "abc")) ((con 2) (con "def")))))))))) (expr (call "main" ("testfunc"))))))))))

;; conformance_suite/test_compile_dict_setitem_subscr.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (function-def "testfunc" () dynamic ((assign ("x") (call (subscript "CheckedDict" (tuple ("int" "str"))) ((dict (((con 1) (con "abc"))))))) (assign ((subscript "x" (con 2))) (con "def")) (return "x"))) (function-def "main" (("test" dynamic)) dynamic ((assign ("x") (call "test" ())) (assert (compare "x" ((== (dict (((con 1) (con "abc")) ((con 2) (con "def")))))))))) (expr (call "main" ("testfunc"))))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (function-def "testfunc" () dynamic ((assign ("x") (call (subscript "CheckedDict" (tuple ("str" "int"))) ((dict (((con "abc") (con 42))))))) (assign ((subscript "x" (con 42))) (con 42))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("pydict")) (function-def "f" (("x" dynamic)) dynamic ((ann-assign "y" "pydict" "x") (return (call (attribute "y" "get") ((con "foo")))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ((dict ()))) ((== (con None))))))) (expr (call "main" ("f"))))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "f" () dynamic (pass)) (function-def "f" () dynamic (pass))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("l") (dict (((con 1) (con "a")) ((con 2) (con "b")) ((con 3) (con "c")) ((con 4) (con "d"))))) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (con 4))))))) (expr (call "main" ("f"))))))))))

;; conformance_suite/test_fast_len_list.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("l") (list ((con 1) (con 2) (con 3) (con 4) (con 5) (con 6) (con 7)))) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (con 7))))))) (expr (call "main" ("f"))))))))))

;; conformance_suite/test_fast_len_list_subclass.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((class "mylist" ("list") ((function-def "__len__" (("self" dynamic)) dynamic ((return (con 1111)))))) (function-def "f" () dynamic ((assign ("l") (call "mylist" ((list ((con 1) (con 2)))))) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (con 1111))))))) (expr (call "main" ("f"))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("a" dynamic) ("b" dynamic)) dynamic ((assign ("l") (set ("a" "b"))) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ((con "a") (con "b"))) ((== (con 2))))))) (expr (call "main" ("f"))))))))))

;; conformance_suite/test_fast_len_set_subclass.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((class "myset" ("set") ((function-def "__len__" (("self" dynamic)) dynamic ((return (con 1111)))))) (function-def "f" () dynamic ((assign ("l") (call "myset" ((list ((con 1) (con 2)))))) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (con 1111))))))) (expr (call "main" ("f"))))))))))

;; conformance_suite/test_fast_len_set_subclass_2.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((class "myset" ("set") ((function-def "__len__" (("self" dynamic)) dynamic ((return (con 1111)))))) (function-def "f" (("x" dynamic) ("a" dynamic) ("b" dynamic)) dynamic ((assign ("l") (set ("a" "b"))) (if "x" ((assign ("l") (call "myset" ((list ("a" "b")))))) ()) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ((con #t) (con 1) (con 2))) ((== (con 1111))))))) (expr (call "main" ("f"))))))))))

;; conformance_suite/test_fast_len_str.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("l") (con "my str!")) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (con 7))))))) (expr (call "main" ("f"))))))))))

;; conformance_suite/test_fast_len_str_subclass.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((class "mystr" ("str") ((function-def "__len__" (("self" dynamic)) dynamic ((return (con 1111)))))) (function-def "f" () dynamic ((assign ("s") (call "mystr" ((con "a")))) (return (call "len" ("s"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (con 1111))))))) (expr (call "main" ("f"))))))))))

;; conformance_suite/test_fast_len_str_subclass_2.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((class "mystr" ("str") ((function-def "__len__" (("self" dynamic)) dynamic ((return (con 1111)))))) (function-def "f" (("x" dynamic)) dynamic ((assign ("s") (con "abc")) (if "x" ((assign ("s") (call "mystr" ((con "pqr"))))) ()) (return (call "len" ("s"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ((con #t))) ((== (con 1111))))) (assert (compare (call "f" ((con #f))) ((== (con 3))))))) (expr (call "main" ("f"))))))))))

;; conformance_suite/test_fast_len_str_unicode_chars.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("l") (con "🤣")) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (con 1))))))) (expr (call "main" ("f"))))))))))

;; conformance_suite/test_fast_len_tuple.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("a" dynamic) ("b" dynamic)) dynamic ((assign ("l") (tuple ("a" "b"))) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ((con "a") (con "b"))) ((== (con 2))))))) (expr (call "main" ("f"))))))))))

;; conformance_suite/test_fast_len_tuple_subclass.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((class "mytuple" ("tuple") ((function-def "__len__" (("self" dynamic)) dynamic ((return (con 1111)))))) (function-def "f" () dynamic ((assign ("l") (call "mytuple" ((list ((con 1) (con 2)))))) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (con 1111))))))) (expr (call "main" ("f"))))))))))

;; conformance_suite/test_fast_len_tuple_subclass_2.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((class "mytuple" ("tuple") ((function-def "__len__" (("self" dynamic)) dynamic ((return (con 1111)))))) (function-def "f" (("x" dynamic) ("a" dynamic) ("b" dynamic)) dynamic ((assign ("l") (tuple ("a" "b"))) (if "x" ((assign ("l") (call "mytuple" ((list ("a" "b")))))) ()) (return (call "len" ("l"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ((con #t) (con 1) (con 2))) ((== (con 1111))))))) (expr (call "main" ("f"))))))))))

;; conformance_suite/test_for_iter_unchecked_get.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("l") (list ((con 1) (con 2) (con 3)))) (assign ("acc") (list ())) (for "x" "l" ((expr (call (attribute "acc" "append") ("x")))) ()) (return "acc"))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (list ((con 1) (con 2) (con 3))))))))) (expr (call "main" ("f"))))))))))

;; conformance_suite/test_frozenset_constant.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("inline")) (function-def "i" (("s" "str")) "bool" ((return (compare "i" ((in (set ((con "a") (con "b"))))))))) (function-def "t" () "bool" ((return (call "i" ((con "p")))))))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((class "A" () ((function-def "m" (("self" dynamic)) "str" ((return (con "hello")))))) (class "B" ("A") ((function-def "m" (("self" dynamic)) "int" ((return (con 0))))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("inline")) (function-def "f" (("x" dynamic) ("y" dynamic)) dynamic ((return (bin-op + "x" "y")))) (function-def "g" () dynamic ((return (call "f" ((con 1) (con 2)))))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("inline")) (function-def "e" (("x" dynamic) ("y" dynamic)) dynamic ((return (bin-op + "x" "y")))) (function-def "f" (("x" dynamic) ("y" dynamic)) dynamic ((return (call "e" ("x" (con 3)))))) (function-def "g" (("a" dynamic) ("b" dynamic)) dynamic ((return (call "f" ("a" "b"))))) (function-def "main" (("g" dynamic)) dynamic ((assert (compare (call "g" ((con 1) (con 2))) ((== (con 4))))))) (expr (call "main" ("g"))))))))))

;; conformance_suite/test_inline_recursive.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("inline")) (function-def "f" (("x" dynamic) ("y" dynamic)) dynamic ((return (call "f" ("x" "y"))))) (function-def "g" () dynamic ((return (call "f" ((con 1) (con 2)))))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "func" () dynamic ((assign ("a") (con 42)) (return (call (attribute "a" "bit_length") ())))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (con 6))))))) (expr (call "main" ("func"))))))))))

;; conformance_suite/test_invoke_str_method.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "func" () dynamic ((assign ("a") (con "a b c")) (return (call (attribute "a" "split") ())))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (list ((con "a") (con "b") (con "c"))))))))) (expr (call "main" ("func"))))))))))

;; conformance_suite/test_invoke_str_method_arg.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "func" () dynamic ((assign ("a") (con "a b c")) (return (call (attribute "a" "split") ((con "a")))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (list ((con "") (con " b c"))))))))) (expr (call "main" ("func"))))))))))

;; conformance_suite/test_invoke_strict_module.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((return (con 42)))) (function-def "g" () dynamic ((return (call "f" ())))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "fib1" (("number" dynamic)) dynamic ((if (compare "number" ((<= (con 1)))) ((return "number")) ()) (return (bin-op + (call "fib" ((bin-op - "number" (con 1)))) (call "fib" ((bin-op - "number" (con 2)))))))) (function-def "fib" (("number" dynamic)) dynamic ((if (compare "number" ((<= (con 1)))) ((return "number")) ()) (return (bin-op + (call "fib1" ((bin-op - "number" (con 1)))) (call "fib1" ((bin-op - "number" (con 2)))))))) (function-def "main" (("fib" dynamic) ("fib1" dynamic)) dynamic ((assert (compare (call "fib" ((con 0))) ((== (con 0))))) (assert (compare (call "fib" ((con 4))) ((== (con 3))))))) (expr (call "main" ("fib" "fib1"))))))))))

;; conformance_suite/test_invoke_strict_module_pre_invoked.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((return (con 42)))) (function-def "g" () dynamic ((return (call "f" ())))) (function-def "main" (("g" dynamic)) dynamic ((assert (compare (call "f" ()) ((== (con 42))))) (assert (compare (call "g" ()) ((== (con 42))))))) (expr (call "main" ("g"))))))))))

;; conformance_suite/test_invoke_strict_module_recursive.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "fib" (("number" dynamic)) dynamic ((if (compare "number" ((<= (con 1)))) ((return "number")) ()) (return (bin-op + (call "fib" ((bin-op - "number" (con 1)))) (call "fib" ((bin-op - "number" (con 2)))))))) (function-def "main" (("fib" dynamic)) dynamic ((assert (compare (call "fib" ((con 4))) ((== (con 3))))))) (expr (call "main" ("fib"))))))))))

;; conformance_suite/test_list_of_dynamic.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "threading" ("Thread")) (import-from "typing" ("List")) (function-def "f" (("threads" (subscript "List" "Thread"))) "int" ((return (call "len" ("threads"))))))))))))

;; conformance_suite/test_max.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("a" "int") ("b" "int")) "int" ((return (call "max" ("a" "b"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ((con 1) (con 3))) ((== (con 3))))) (assert (compare (call "f" ((con 3) (con 1))) ((== (con 3))))))) (expr (call "main" ("f"))))))))))

;; conformance_suite/test_method_prologue.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("x" "str")) dynamic ((return (con 42)))) (function-def "main" (("f" dynamic)) dynamic ((try ((expr (call "f" ((con 42))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()))) (expr (call "main" ("f"))))))))))

;; conformance_suite/test_method_prologue_2.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("x" dynamic) ("y" "str")) dynamic ((return (con 42)))) (function-def "main" (("f" dynamic)) dynamic ((try ((expr (call "f" ((con "abc") (con 42))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()))) (expr (call "main" ("f"))))))))))

;; conformance_suite/test_method_prologue_3.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("x" "int") ("y" "str")) dynamic ((return (con 42)))) (function-def "main" (("f" dynamic)) dynamic ((try ((expr (call "f" ((con 42) (con 42))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()))) (expr (call "main" ("f"))))))))))

;; conformance_suite/test_method_prologue_no_annotation.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("x" dynamic)) dynamic ((return (con 42)))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ((con "abc"))) ((== (con 42))))))) (expr (call "main" ("f"))))))))))

;; conformance_suite/test_min.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("a" "int") ("b" "int")) "int" ((return (call "min" ("a" "b"))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ((con 1) (con 3))) ((== (con 1))))) (assert (compare (call "f" ((con 3) (con 1))) ((== (con 1))))))) (expr (call "main" ("f"))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () "int" ((assign ("l") (bin-op * (list ((con 1) (con 2) (con 3))) (con 2))) (return (call "len" ("l"))))) (function-def "main" () dynamic ((assert (compare (call "f" ()) ((== (con 6))))))) (expr (call "main" ())))))))))

;; conformance_suite/test_multiply_list_exact_by_int_reverse.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () "int" ((assign ("l") (bin-op * (con 2) (list ((con 1) (con 2) (con 3))))) (return (call "len" ("l"))))) (function-def "main" () dynamic ((assert (compare (call "f" ()) ((== (con 6))))))) (expr (call "main" ())))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("i" "int") ("j" "str") ("l" "int") ("m" "int") ("n" "int") ("o" "int")) "bool" ((function-def "g" (("k" "int")) "bool" ((return (if-exp (compare "j" ((== (con "gt")))) (compare "k" ((> (con 0)))) (compare "k" ((<= (con 0)))))))) (return (call "g" ("i"))))) (function-def "main" (("f" dynamic)) dynamic ((try ((expr (call "f" ((con 1) (con "a") (con 2) (con 3) (con "4") (con 5))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()))) (expr (call "main" ("f"))))))))))

;; conformance_suite/test_nested_fn_type_error_2.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("i" "int") ("j" "str") ("k" "int")) "bool" ((function-def "g" (("k" "int")) "bool" ((return (if-exp (compare "j" ((== (con "gt")))) (compare "k" ((> (con 0)))) (compare "k" ((<= (con 0)))))))) (return (call "g" ("i"))))) (function-def "main" (("f" dynamic)) dynamic ((try ((expr (call "f" ((con 1) (con 2) (con 3))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()))) (expr (call "main" ("f"))))))))))

;; conformance_suite/test_no_narrow_to_dynamic.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((return (con 42)))) (function-def "g" () dynamic ((ann-assign "x" "int" (con 100)) (assign ("x") (call "f" ())) (return (call (attribute "x" "bit_length") ())))) (function-def "main" (("g" dynamic)) dynamic ((assert (compare (call "g" ()) ((== (con 6))))))) (expr (call "main" ("g"))))))))))

;; conformance_suite/test_nonarray_len.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((class "Lol" () ((function-def "__len__" (("self" dynamic)) dynamic ((return (con 421)))))) (function-def "y" () dynamic ((return (call "len" ((call "Lol" ())))))) (function-def "main" (("y" dynamic)) dynamic ((assert (compare (call "y" ()) ((== (con 421))))))) (expr (call "main" ("y"))))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("x") (con None)) (return (attribute "x" "foo"))))))))))

;; conformance_suite/test_none_call.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("x") (con None)) (return (call "x" ()))))))))))

;; conformance_suite/test_none_compare.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "f" (("x" (bin-op bit-or "int" (con None)))) dynamic ((if (compare "x" ((> (con 1)))) ((assign ("x") (con 1))) ()) (return "x")))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((class "C" () ((function-def "__init__" (("self" dynamic) ("y" "int")) dynamic ((assign ((attribute "self" "y")) "y"))))) (function-def "f" (("c" "C")) "int" ((return (attribute "c" "y")))))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((import-from "typing" ("Optional")) (function-def "f" (("a" (subscript "Optional" "int"))) dynamic ((expr (subscript "a" (con 1)))))))))))

;; conformance_suite/test_optional_unary_error.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((import-from "typing" ("Optional")) (function-def "f" (("a" (subscript "Optional" "int"))) dynamic ((expr (unary-op - "a"))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict")) (function-def "f" (("d" (subscript "PyDict" (tuple ("str" "int"))))) "str" ((return (subscript "d" (con 3))))) (function-def "main" () dynamic ((assert (compare (call "f" ((dict (((con 3) (con "foo")))))) ((== (con "foo"))))))) (expr (call "main" ())))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("Any")) (function-def "testfunc" (("x" "str") ("y" "str")) "bool" ((return (compare "x" ((== "y")))))) (function-def "main" (("f" dynamic)) dynamic ((assert (compare (call "f" ((con "abc") (con "abc"))) ((== (con #t))))))) (expr (call "main" ("testfunc"))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("l") (list ((con 1) (con 2)))) (return (bin-op * (con 2) "l")))) (function-def "main" () dynamic ((assert (compare (call "f" ()) ((== (list ((con 1) (con 2) (con 1) (con 2))))))))) (expr (call "main" ())))))))))

;; conformance_suite/test_seq_repeat_tuple.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("t") (tuple ((con 1) (con 2)))) (return (bin-op * "t" (con 2))))) (function-def "main" () dynamic ((assert (compare (call "f" ()) ((== (tuple ((con 1) (con 2) (con 1) (con 2))))))))) (expr (call "main" ())))))))))

;; conformance_suite/test_seq_repeat_tuple_reversed.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("t") (tuple ((con 1) (con 2)))) (return (bin-op * (con 2) "t")))) (function-def "main" () dynamic ((assert (compare (call "f" ()) ((== (tuple ((con 1) (con 2) (con 1) (con 2))))))))) (expr (call "main" ())))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("List")) (function-def "f1" (("x" "List")) dynamic ((try ((return (con None))) () () ((expr (call (attribute "x" "append") ((con "hi")))))))) (function-def "main" (("f1" dynamic)) dynamic ((assign ("l") (list ())) (expr (call "f1" ("l"))) (assert (compare "l" ((== (list ((con "hi"))))))))) (expr (call "main" ("f1"))))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "x" (("v" "str")) dynamic ((return (con "abc")))) (function-def "y" (("v" dynamic)) dynamic ((return (call "x" ("v"))))) (function-def "main" (("y" dynamic)) dynamic ((try ((expr (call "y" ((con 42))))) ((except-handler "TypeError" None (pass))) ((raise (call "Exception" ()))) ()) (assert (compare (call "y" ((con "foo"))) ((== (con "abc"))))))) (expr (call "main" ("y"))))))))))

;; conformance_suite/test_verify_lambda.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((assign ("x") (lambda (("x" dynamic)) "x")) (assign ("a") (call "x" ((con "hi")))) (function-def "main" () dynamic ((assert (compare "a" ((== (con "hi"))))))) (expr (call "main" ())))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((assign ("x") (con 0)) (if "x" (pass) ((function-def "f" () dynamic ((return (con 42)))))) (function-def "main" () dynamic ((assert (compare (call "f" ()) ((== (con 42))))))) (expr (call "main" ())))))))))
...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((try ((ann-assign "x" "int" (con 42))) ((except-handler "Exception" None (pass))) (pass) (pass)) (assert (compare "x" ((is (con 42))))))))))))

;; conformance_suite/try_except_catch_else_no_exn.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((try (pass) ((except-handler "Exception" None ((return (con 2))))) ((return (con 3))) ()))) (assert (compare (call "f" ()) ((is (con 3))))))))))))

;; conformance_suite/try_except_catch_else_some_exn.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((try ((raise (call "Exception" ((con "foo"))))) ((except-handler "Exception" None ((return (con 2))))) ((return (con 3))) ()))) (assert (compare (call "f" ()) ((is (con 2))))))))))))

;; conformance_suite/try_except_catch_final_no_exn.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((try (pass) ((except-handler "Exception" None ((return (con 2))))) ((return (con 3))) ((return (con 42)))))) (assert (compare (call "f" ()) ((is (con 42))))))))))))

;; conformance_suite/try_except_catch_final_some_exn.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((try ((raise (call "Exception" ((con "foo"))))) ((except-handler "Exception" None ((return (con 2))))) ((return (con 3))) ((return (con 42)))))) (assert (compare (call "f" ()) ((is (con 42))))))))))))

;; conformance_suite/try_except_catch_same_class.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((try ((raise (call "Exception" ((con "foo"))))) ((except-handler "Exception" None ((return (con 42))))) () ()))) (assert (compare (call "f" ()) ((is (con 42))))))))))))

;; conformance_suite/try_except_catch_sub_class.py
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((class "C" ("Exception") (pass)) (function-def "f" () dynamic ((try ((raise (call "C" ((con "foo"))))) ((except-handler "Exception" None ((return (con 42))))) () ()))) (assert (compare (call "f" ()) ((is (con 42))))))))))))
