...
(test-match SP-compiled program- (term (compile-program (desugar-program ((class "C" () ((function-def "m" (("self" dynamic)) dynamic ((return (con 2)))))) (assign (attribute "C" "m") (lambda (("self" dynamic)) (con 3))))))))
