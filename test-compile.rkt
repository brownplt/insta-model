...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (ann-assign "x" (subscript "CheckedDict" (tuple-syntax ("str" "int"))) (call (subscript "CheckedDict" (tuple-syntax ("str" "int"))) ((dict-syntax (((con "foo") (con 2)) ((con "bar") (con 3))))))) (delete (subscript "x" (con "other"))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (ann-assign "x" (subscript "CheckedDict" (tuple-syntax ("str" "int"))) (call (subscript "CheckedDict" (tuple-syntax ("str" "int"))) ((dict-syntax (((con "foo") (con 2)) ((con "bar") (con 3))))))) (delete (subscript "x" (con "bar"))))))))

;; conformance_suite/CheckedDict_delete_pos.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict" "CheckedDict")) (ann-assign "x" (subscript "CheckedDict" (tuple-syntax ("str" "int"))) (call (subscript "CheckedDict" (tuple-syntax ("str" "int"))) ((dict-syntax (((con "foo") (con 1))))))) (delete (subscript "x" (con "foo"))))))))

;; conformance_suite/CheckedDict_delete_then_lookup.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (ann-assign "x" (subscript "CheckedDict" (tuple-syntax ("str" "int"))) (call (subscript "CheckedDict" (tuple-syntax ("str" "int"))) ((dict-syntax (((con "foo") (con 2)) ((con "bar") (con 3))))))) (delete (subscript "x" (con "bar"))) (expr (subscript "x" (con "bar"))))))))

;; conformance_suite/CheckedDict_from_bad_dict.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (ann-assign "x" (subscript "CheckedDict" (tuple-syntax ("int" "str"))) (call (subscript "CheckedDict" (tuple-syntax ("int" "str"))) ((dict-syntax (((con 2) (con "a")) ((con 3) (con 4))))))))))))

;; conformance_suite/CheckedDict_from_good_dict.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (ann-assign "x" (subscript "CheckedDict" (tuple-syntax ("int" "str"))) (call (subscript "CheckedDict" (tuple-syntax ("int" "str"))) ((dict-syntax (((con 2) (con "a")) ((con 3) (con "b"))))))))))))

;; conformance_suite/CheckedDict_from_nondict.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (ann-assign "x" (subscript "CheckedDict" (tuple-syntax ("int" "str"))) (call (subscript "CheckedDict" (tuple-syntax ("int" "str"))) ((con 42)))))))))

;; conformance_suite/CheckedDict_insert.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (ann-assign "x" (subscript "CheckedDict" (tuple-syntax ("str" "int"))) (call (subscript "CheckedDict" (tuple-syntax ("str" "int"))) ((dict-syntax (((con "foo") (con 2)) ((con "bar") (con 3))))))) (assign (subscript "x" (con "new")) (con 4)))))))

;; conformance_suite/CheckedDict_insert_then_lookup.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (ann-assign "x" (subscript "CheckedDict" (tuple-syntax ("str" "int"))) (call (subscript "CheckedDict" (tuple-syntax ("str" "int"))) ((dict-syntax ())))) (assign (subscript "x" (con "foo")) (con 42)) (expr (subscript "x" (con "foo"))))))))

;; conformance_suite/CheckedDict_is_inhabitable.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (ann-assign "x" (subscript "CheckedDict" (tuple-syntax ("str" "int"))) (call (subscript "CheckedDict" (tuple-syntax ("str" "int"))) ((dict-syntax (((con "foo") (con 2)) ((con "bar") (con 3))))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict" "CheckedDict")) (ann-assign "x" (subscript "CheckedDict" (tuple-syntax ("str" "int"))) (call (subscript "CheckedDict" (tuple-syntax ("str" "int"))) ((dict-syntax (((con "foo") (con 1))))))) (expr (subscript "x" (con "foo"))))))))

;; conformance_suite/CheckedDict_lookup_val_pos.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict" "CheckedDict")) (ann-assign "x" (subscript "CheckedDict" (tuple-syntax ("str" "int"))) (call (subscript "CheckedDict" (tuple-syntax ("str" "int"))) ((dict-syntax (((con "foo") (con 1))))))) (ann-assign "y" "int" (subscript "x" (con "foo"))))))))

;; conformance_suite/CheckedDict_update.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (ann-assign "x" (subscript "CheckedDict" (tuple-syntax ("str" "int"))) (call (subscript "CheckedDict" (tuple-syntax ("str" "int"))) ((dict-syntax (((con "foo") (con 2)) ((con "bar") (con 3))))))) (assign (subscript "x" (con "bar")) (con 4)))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict" "CheckedDict")) (ann-assign "x" (subscript "CheckedDict" (tuple-syntax ("str" "int"))) (call (subscript "CheckedDict" (tuple-syntax ("str" "int"))) ((dict-syntax (((con "foo") (con 1))))))) (assign (subscript "x" (con "bar")) (con 3)))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict" "CheckedDict")) (ann-assign "x" (subscript "CheckedDict" (tuple-syntax ("str" "int"))) (call (subscript "CheckedDict" (tuple-syntax ("str" "int"))) ((dict-syntax (((con "foo") (con 1))))))) (assign (subscript "x" (con "bar")) (con 2)))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict")) (ann-assign "x" "PyDict" (dict-syntax (((con 1) (con "foo")) ((con "bar") (con 2))))) (delete (subscript "x" (con "other"))))))))

;; conformance_suite/PyDict_delete_good_key.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict")) (ann-assign "x" "PyDict" (dict-syntax (((con 1) (con "foo")) ((con "bar") (con 2))))) (delete (subscript "x" (con "bar"))))))))

;; conformance_suite/PyDict_delete_then_lookup.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict")) (ann-assign "x" "PyDict" (dict-syntax (((con 1) (con "foo")) ((con "bar") (con 2))))) (delete (subscript "x" (con "bar"))) (expr (subscript "x" (con "bar"))))))))

;; conformance_suite/PyDict_insert.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict")) (ann-assign "x" "PyDict" (dict-syntax (((con 1) (con "foo")) ((con "bar") (con 2))))) (assign (subscript "x" (con "new")) (con "hello")))))))

;; conformance_suite/PyDict_insert_then_lookup.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict")) (ann-assign "x" "PyDict" (dict-syntax ())) (assign (subscript "x" (con "foo")) (con 42)) (expr (subscript "x" (con "foo"))))))))

;; conformance_suite/PyDict_is_inhabitable.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict")) (ann-assign "x" "PyDict" (dict-syntax (((con 1) (con "foo")) ((con "bar") (con 2))))))))))

;; conformance_suite/PyDict_lookup_bad_key.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict")) (ann-assign "x" "PyDict" (dict-syntax (((con 1) (con "foo")) ((con "bar") (con 2))))) (expr (subscript "x" (con "other"))))))))

;; conformance_suite/PyDict_lookup_good_key.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict")) (ann-assign "x" "PyDict" (dict-syntax (((con 1) (con "foo")) ((con "bar") (con 2))))) (expr (subscript "x" (con "bar"))))))))

;; conformance_suite/PyDict_update.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict")) (ann-assign "x" "PyDict" (dict-syntax (((con 1) (con "foo")) ((con "bar") (con 2))))) (assign (subscript "x" (con "bar")) (con "hello")))))))

;; conformance_suite/PyDict_update_then_lookup.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict")) (ann-assign "x" "PyDict" (dict-syntax (((con "foo") (con 2))))) (assign (subscript "x" (con "foo")) (con 3)) (assert (compare (subscript "x" (con "foo")) ((is (con 3))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("pydict")) (class "B" () (pass)) (class "D" ("B") (pass)) (function-def "testfunc" () dynamic ((ann-assign "x" "pydict" (dict-syntax (((call "B" ()) (con 42)) ((call "D" ()) (con 42))))) (return "x"))))))))

;; conformance_suite/test_compile_checked_dict_explicit_dict_as_dict.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("pydict")) (class "B" () (pass)) (class "D" ("B") (pass)) (function-def "testfunc" () dynamic ((ann-assign "x" "dict" (dict-syntax (((call "B" ()) (con 42)) ((call "D" ()) (con 42))))) (return "x"))))))))

;; conformance_suite/test_compile_checked_dict_len.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (function-def "testfunc" () dynamic ((assign "x" (call (subscript "CheckedDict" (tuple-syntax ("int" "str"))) ((dict-syntax (((con 1) (con "abc"))))))) (return (call "len" ("x"))))))))))

;; conformance_suite/test_compile_checked_dict_opt_out_by_default.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((class "B" () (pass)) (class "D" ("B") (pass)) (function-def "testfunc" () dynamic ((assign "x" (dict-syntax (((call "B" ()) (con 42)) ((call "D" ()) (con 42))))) (return "x"))))))))

;; conformance_suite/test_compile_checked_dict_optional.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (import-from "typing" ("Optional")) (function-def "testfunc" () dynamic ((assign "x" (call (subscript "CheckedDict" (tuple-syntax ("str" (bin-op bit-or "str" (con None))))) ((dict-syntax (((con "x") (con None)) ((con "y") (con "z"))))))) (return "x"))))))))

;; conformance_suite/test_compile_checked_dict_reversed.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (class "B" () (pass)) (class "D" ("B") (pass)) (function-def "testfunc" () dynamic ((assign "x" (call (subscript "CheckedDict" (tuple-syntax ("B" "int"))) ((dict-syntax (((call "D" ()) (con 42)) ((call "B" ()) (con 42))))))) (return "x"))))))))

;; conformance_suite/test_compile_checked_dict_type_specified.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (class "B" () (pass)) (class "D" ("B") (pass)) (function-def "testfunc" () dynamic ((ann-assign "x" (subscript "CheckedDict" (tuple-syntax ("B" "int"))) (call (subscript "CheckedDict" (tuple-syntax ("B" "int"))) ((dict-syntax (((call "D" ()) (con 42))))))) (return "x"))))))))

;; conformance_suite/test_compile_checked_dict_with_annotation.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (class "B" () (pass)) (function-def "testfunc" () dynamic ((ann-assign "x" (subscript "CheckedDict" (tuple-syntax ("B" "int"))) (dict-syntax (((call "B" ()) (con 42))))) (return "x"))))))))

;; conformance_suite/test_compile_dict_setitem.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (function-def "testfunc" () dynamic ((assign "x" (call (subscript "CheckedDict" (tuple-syntax ("int" "str"))) ((dict-syntax (((con 1) (con "abc"))))))) (expr (call (attribute "x" "__setitem__") ((con 2) (con "def")))) (return "x"))))))))

;; conformance_suite/test_compile_dict_setitem_subscr.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (function-def "testfunc" () dynamic ((assign "x" (call (subscript "CheckedDict" (tuple-syntax ("int" "str"))) ((dict-syntax (((con 1) (con "abc"))))))) (assign (subscript "x" (con 2)) (con "def")) (return "x"))))))))

;; conformance_suite/test_compile_nested_class_in_fn.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "fn" () dynamic ((class "C" () ((ann-assign "c" "int" (con 1)))) (return (call "C" ())))))))))

;; conformance_suite/test_compile_nested_dict.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (class "B" () (pass)) (class "D" ("B") (pass)) (function-def "testfunc" () dynamic ((assign "x" (call (subscript "CheckedDict" (tuple-syntax ("B" "int"))) ((dict-syntax (((call "B" ()) (con 42)) ((call "D" ()) (con 42))))))) (assign "y" (call (subscript "CheckedDict" (tuple-syntax ("int" (subscript "CheckedDict" (tuple-syntax ("B" "int")))))) ((dict-syntax (((con 42) "x")))))) (return "y"))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("Final")) (ann-assign "X" "str" (con "omg")) (function-def "f" () "str" ((return (subscript "X" (con 1))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("inline")) (function-def "f" (("x" dynamic) ("y" dynamic)) dynamic ((return (call "f" ("x" "y"))))) (function-def "g" () dynamic ((return (call "f" ((con 1) (con 2)))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((return (con 42)))) (function-def "g" () dynamic ((return (call "f" ())))))))))
