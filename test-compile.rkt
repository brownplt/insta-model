...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (ann-assign "x" (subscript "CheckedDict" (tuple ("int" "str"))) (call (subscript "CheckedDict" (tuple ("int" "str"))) ((dict (((con 2) (con "a")) ((con 3) (con 4))))))))))))

;; conformance_suite/CheckedDict_from_good_dict.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (ann-assign "x" (subscript "CheckedDict" (tuple ("int" "str"))) (call (subscript "CheckedDict" (tuple ("int" "str"))) ((dict (((con 2) (con "a")) ((con 3) (con "b"))))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" () dynamic ((return (con 2)))) (assert (compare (call "type" ("f")) ((is (call "type" ((lambda () (con 3)))))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((class "C" () ((assign "m" (lambda (("self" dynamic)) (con 2))))) (assign "obj" (call "C" ())) (assert (compare (call (attribute "obj" "m") ()) ((is (con 2))))))))))

;; conformance_suite/method_generative.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((class "C" () ((assign "m1" (lambda (("self" dynamic)) (con 2))) (function-def "m2" (("self" dynamic)) dynamic ((return (con 3)))))) (assign "obj" (call "C" ())) (assert (compare (attribute "obj" "m1") ((is-not (attribute "obj" "m1"))))) (assert (compare (attribute "obj" "m2") ((is-not (attribute "obj" "m2"))))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((import-from "typing" ("Final")) (function-def "f" (("a" "Final")) (con None) (pass))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((class "A" () ((function-def "m" (("self" dynamic) ("x" "str")) "int" ((return (con 42)))))) (class "B" ("A") ((function-def "m" (("self" dynamic) ("y" "str")) "int" ((return (con 0))))))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((import-from "typing" ("Final")) (ann-assign "x" "Final")))))))
