...
(check-not-exn (lambda () (test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("Optional")) (class "C" () ((ann-assign "x" (subscript "Optional" "C")) (function-def "__init__" (("self" dynamic)) dynamic ((assign ((attribute "self" "x")) (con None)))))) (assign ("c") (call "C" ())) (assert (compare (attribute "c" "x") ((== (con None))))))))))))
