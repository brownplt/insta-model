...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "f" () dynamic ((ann-assign "x" "object" (bin-op + (con 42) (con 1)))))))))))

;; conformance_suite/test_assign_dynamic_to_dynamic.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "f" (("C" dynamic)) dynamic ((ann-assign "x" "unknown" (call "C" ()))))))))))

;; conformance_suite/test_assign_dynamic_to_object.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "f" (("C" dynamic)) dynamic ((ann-assign "x" "object" (call "C" ()))))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "f" () dynamic ((ann-assign "x" "foo" (con 42))))))))))

;; conformance_suite/test_assign_num_to_object.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "f" () dynamic ((ann-assign "x" "object" (con 42))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("l" dynamic)) dynamic ((aug-assign (subscript "l" (con 0)) + (con 1)))))))))

;; conformance_suite/test_augassign_inexact.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "something" () dynamic ((return (con 3)))) (function-def "t" () dynamic ((ann-assign "a" "int" (call "something" ())) (assign ("b") (con 0)) (aug-assign "b" + "a") (return "b"))))))))

;; conformance_suite/test_bind_boolop_type.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("Any")) (class "C" () ((function-def "f" (("self" dynamic)) "bool" ((return (con #t)))) (function-def "g" (("self" dynamic)) "bool" ((return (con #f)))) (function-def "x" (("self" dynamic)) "bool" ((return (bool-op and ((call (attribute "self" "f") ()) (call (attribute "self" "g") ())))))) (function-def "y" (("self" dynamic)) "bool" ((return (bool-op or ((call (attribute "self" "f") ()) (call (attribute "self" "g") ())))))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (function-def "testfunc" () dynamic ((ann-assign "x" (subscript "CheckedDict" (tuple ("int" "str"))) (dict ())) (return "x"))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "dec" (("f" dynamic)) dynamic ((return "f"))) (class "C" () ((function-def "foo" (("self" dynamic)) "int" ((return (con 3)))) (function-def "f" (("self" dynamic)) dynamic ((return (call (attribute "self" "foo") ())))))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((class "C" () (pass)) (class "D" ("C") (pass)) (assign ("x") (compare (call "C" ()) ((> (call "D" ())))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("pydict")) (class "B" () (pass)) (class "D" ("B") (pass)) (function-def "testfunc" () dynamic ((ann-assign "x" "pydict" (dict (((call "B" ()) (con 42)) ((call "D" ()) (con 42))))) (return "x"))))))))

;; conformance_suite/test_compile_checked_dict_explicit_dict_as_dict.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("pydict")) (class "B" () (pass)) (class "D" ("B") (pass)) (function-def "testfunc" () dynamic ((ann-assign "x" "dict" (dict (((call "B" ()) (con 42)) ((call "D" ()) (con 42))))) (return "x"))))))))

;; conformance_suite/test_compile_checked_dict_len.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (function-def "testfunc" () dynamic ((assign ("x") (call (subscript "CheckedDict" (tuple ("int" "str"))) ((dict (((con 1) (con "abc"))))))) (return (call "len" ("x"))))))))))

;; conformance_suite/test_compile_checked_dict_opt_out_by_default.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((class "B" () (pass)) (class "D" ("B") (pass)) (function-def "testfunc" () dynamic ((assign ("x") (dict (((call "B" ()) (con 42)) ((call "D" ()) (con 42))))) (return "x"))))))))

;; conformance_suite/test_compile_checked_dict_optional.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (import-from "typing" ("Optional")) (function-def "testfunc" () dynamic ((assign ("x") (call (subscript "CheckedDict" (tuple ("str" (bin-op bit-or "str" (con None))))) ((dict (((con "x") (con None)) ((con "y") (con "z"))))))) (return "x"))))))))

;; conformance_suite/test_compile_checked_dict_reversed.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (class "B" () (pass)) (class "D" ("B") (pass)) (function-def "testfunc" () dynamic ((assign ("x") (call (subscript "CheckedDict" (tuple ("B" "int"))) ((dict (((call "D" ()) (con 42)) ((call "B" ()) (con 42))))))) (return "x"))))))))

;; conformance_suite/test_compile_checked_dict_shadowcode.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (class "B" () (pass)) (class "D" ("B") (pass)) (function-def "testfunc" () dynamic ((assign ("x") (call (subscript "CheckedDict" (tuple ("B" "int"))) ((dict (((call "B" ()) (con 42)) ((call "D" ()) (con 42))))))) (return "x"))))))))

;; conformance_suite/test_compile_checked_dict_type_specified.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (class "B" () (pass)) (class "D" ("B") (pass)) (function-def "testfunc" () dynamic ((ann-assign "x" (subscript "CheckedDict" (tuple ("B" "int"))) (call (subscript "CheckedDict" (tuple ("B" "int"))) ((dict (((call "D" ()) (con 42))))))) (return "x"))))))))

;; conformance_suite/test_compile_checked_dict_with_annotation.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (class "B" () (pass)) (function-def "testfunc" () dynamic ((ann-assign "x" (subscript "CheckedDict" (tuple ("B" "int"))) (dict (((call "B" ()) (con 42))))) (return "x"))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("CheckedDict")) (function-def "testfunc" () dynamic ((assign ("x") (call (subscript "CheckedDict" (tuple ("int" "str"))) ((dict (((con 42) (con "abc"))))))) (ann-assign "y" (bin-op bit-or "str" (con None)) (call (attribute "x" "get") ((con 42)))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("ClassVar")) (class "Outer" () ((class "Inner" () ((ann-assign "c" (subscript "ClassVar" "int") (con 1)))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("pydict")) (function-def "f" (("x" dynamic)) dynamic ((ann-assign "y" "pydict" "x") (return (call (attribute "y" "get") ((con "foo")))))))))))

;; conformance_suite/test_dict_invoke_ret.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("pydict")) (function-def "g" () dynamic ((return (con None)))) (function-def "f" (("x" dynamic)) dynamic ((ann-assign "y" "pydict" "x") (assign ("z") (call (attribute "y" "get") ((con "foo")))) (assign ("z") (con None)) (return "z"))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "f" () "str" ((return (call (attribute (con ", ") "join") ((list ((con "1") (con "2") (con "3"))))))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("inline")) (function-def "e" (("x" dynamic) ("y" dynamic)) dynamic ((return (bin-op + "x" "y")))) (function-def "f" (("x" dynamic) ("y" dynamic)) dynamic ((return (call "e" ("x" (con 3)))))) (function-def "g" () dynamic ((return (call "f" ((con 1) (con 2)))))))))))

;; conformance_suite/test_inline_nested_arg.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("inline")) (function-def "e" (("x" dynamic) ("y" dynamic)) dynamic ((return (bin-op + "x" "y")))) (function-def "f" (("x" dynamic) ("y" dynamic)) dynamic ((return (call "e" ("x" (con 3)))))) (function-def "g" (("a" dynamic) ("b" dynamic)) dynamic ((return (call "f" ("a" "b"))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "func" () dynamic ((assign ("a") (con 42)) (return (call (attribute "a" "bit_length") ())))))))))

;; conformance_suite/test_invoke_method_non_static_base.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((class "C" ("Exception") ((function-def "f" (("self" dynamic)) dynamic ((return (con 42)))) (function-def "g" (("self" dynamic)) dynamic ((return (call (attribute "self" "f") ())))))))))))

;; conformance_suite/test_invoke_str_method_arg.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "func" () dynamic ((assign ("a") (con "a b c")) (return (call (attribute "a" "split") ((con "a")))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("x" dynamic)) dynamic ((return (con 42)))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "f" () "int" ((assign ("l") (bin-op * (list ((con 1) (con 2) (con 3))) (con 2))) (return (call "len" ("l")))))))))))

;; conformance_suite/test_multiply_list_exact_by_int_reverse.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "f" () "int" ((assign ("l") (bin-op * (con 2) (list ((con 1) (con 2) (con 3))))) (return (call "len" ("l")))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("i" "int") ("j" "str") ("l" "int") ("m" "int") ("n" "int") ("o" "int")) "bool" ((function-def "g" (("k" "int")) "bool" ((return (if-exp (compare "j" ((== (con "gt")))) (compare "k" ((> (con 0)))) (compare "k" ((<= (con 0)))))))) (return (call "g" ("i"))))))))))

;; conformance_suite/test_nested_fn_type_error_2.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "f" (("i" "int") ("j" "str") ("k" "int")) "bool" ((function-def "g" (("k" "int")) "bool" ((return (if-exp (compare "j" ((== (con "gt")))) (compare "k" ((> (con 0)))) (compare "k" ((<= (con 0)))))))) (return (call "g" ("i"))))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((class "Lol" () ((function-def "__len__" (("self" dynamic)) dynamic ((return (con 421)))))) (function-def "y" () dynamic ((return (call "len" ((call "Lol" ()))))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "__static__" ("PyDict")) (function-def "f" (("d" (subscript "PyDict" (tuple ("str" "int"))))) "str" ((return (subscript "d" (con 3))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("Optional")) (function-def "f" (("s" (subscript "Optional" "str"))) "str" ((return (bool-op or ("s" (con "hi")))))))))))

;; conformance_suite/test_refine_or_expression_with_multiple_optionals.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("Optional")) (function-def "f" (("s1" (subscript "Optional" "str")) ("s2" (subscript "Optional" "str"))) "str" ((return (bool-op or ("s1" "s2" (con "hi")))))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((import-from "typing" ("List")) (function-def "f" (("l" (subscript "List" "int"))) dynamic ((return (bin-op * "l" (con 2)))))))))))

;; conformance_suite/test_seq_repeat_inexact_num.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "f" (("num" "int")) dynamic ((return (bin-op * "num" (list ((con 1) (con 2)))))))))))))

;; conformance_suite/test_seq_repeat_inexact_tuple.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((import-from "typing" ("Tuple")) (function-def "f" (("t" (subscript "Tuple" "int"))) dynamic ((return (bin-op * "t" (con 2)))))))))))

;; conformance_suite/test_seq_repeat_list.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("l") (list ((con 1) (con 2)))) (return (bin-op * "l" (con 2)))))))))))

;; conformance_suite/test_seq_repeat_list_reversed.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("l") (list ((con 1) (con 2)))) (return (bin-op * (con 2) "l"))))))))))

;; conformance_suite/test_seq_repeat_tuple.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("t") (tuple ((con 1) (con 2)))) (return (bin-op * "t" (con 2)))))))))))

;; conformance_suite/test_seq_repeat_tuple_reversed.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("t") (tuple ((con 1) (con 2)))) (return (bin-op * (con 2) "t"))))))))))
...
(test-match SP-compiled program- (term (compile-program (desugar-program ((function-def "get_str" () "str" ((return (con "something here")))) (function-def "test" () "str" ((assign ((tuple ("a" "b"))) (call (attribute (call "get_str" ()) "split") ((con None) (con 1)))) (return "b"))))))))

;; conformance_suite/test_try_return_finally.py
(test-match SP-compiled program- (term (compile-program (desugar-program ((import-from "typing" ("List")) (function-def "f1" (("x" "List")) dynamic ((try-except-else-finally ((return (con None))) () () ((expr (call (attribute "x" "append") ((con "hi")))))))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "test" (("a" dynamic)) dynamic ((ann-assign "x" "int") (ann-assign "y" "str") (assign ((tuple ("x" "y"))) (tuple ((con 1) "a")))))))))))

;; conformance_suite/test_typed_swap_2.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "test" (("a" dynamic)) dynamic ((ann-assign "x" "int") (ann-assign "y" "str") (assign ((tuple ("x" "y"))) (tuple ("a" (con "abc"))))))))))))

;; conformance_suite/test_typed_swap_list.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "test" (("a" dynamic)) dynamic ((ann-assign "x" "int") (ann-assign "y" "str") (assign ((list ("x" "y"))) (tuple ("a" (con "abc"))))))))))))

;; conformance_suite/test_typed_swap_member.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((class "C" () ((function-def "__init__" (("self" dynamic)) dynamic ((ann-assign (attribute "self" "x") "int" (con 42)))))) (function-def "test" (("a" dynamic)) dynamic ((ann-assign "x" "int") (ann-assign "y" "str") (assign ((tuple ((attribute (call "C" ()) "x") "y"))) (tuple ("a" (con "abc"))))))))))))

;; conformance_suite/test_typed_swap_nested.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "test" (("a" dynamic)) dynamic ((ann-assign "x" "int") (ann-assign "y" "str") (ann-assign "z" "str") (assign ((tuple ((tuple ("x" "y")) "z"))) (tuple ((tuple ("a" (con "abc"))) (con "foo"))))))))))))

;; conformance_suite/test_typed_swap_nested_2.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "test" (("a" dynamic)) dynamic ((ann-assign "x" "int") (ann-assign "y" "str") (ann-assign "z" "str") (assign ((tuple ((tuple ("x" "y")) "z"))) (tuple ((tuple ((con 1) "a")) (con "foo"))))))))))))

;; conformance_suite/test_typed_swap_nested_3.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "test" (("a" dynamic)) dynamic ((ann-assign "x" "int") (ann-assign "y" "int") (ann-assign "z" "str") (assign ((tuple ((tuple ("x" "y")) "z"))) (tuple ((tuple ((con 1) (con 2))) "a")))))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "x" (("a" dynamic) ("b" dynamic)) dynamic ((assign ("z") (bin-op + "a" "b"))))))))))

;; conformance_suite/test_unknown_type_compare.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "x" (("a" dynamic) ("b" dynamic)) dynamic ((assign ("z") (compare "a" ((> "b"))))))))))))

;; conformance_suite/test_unknown_type_unary.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "x" (("y" dynamic)) dynamic ((assign ("z") (unary-op - "y"))))))))))

;; conformance_suite/test_untyped_attr.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((assign ("y") (attribute "x" "load")) (assign ((attribute "x" "store")) (con 42)) (delete (attribute "x" "delete"))))))))

;; conformance_suite/test_verify_arg_unknown_type.py
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "x" (("x" "foo")) dynamic ((return "b"))) (expr (call "x" ((con "abc"))))))))))
...
(check-exn exn:fail:redex? (lambda () (term (compile-program (desugar-program ((function-def "f" () dynamic ((assign ("x") (call "Exception" ())) (return (call (attribute "x" "with_traceback") ((con None))))))))))))
