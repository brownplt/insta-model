...
(test-match SP program+ (term ((function-def "f" (("l" dynamic)) dynamic ((aug-assign (subscript "l" (con 0)) + (con 1)))) (assert (compare (subscript "l" (con 0)) ((== (con 2))))))))

;; conformance_suite/test_augassign_inexact.py
(test-match SP program+ (term ((function-def "something" () dynamic ((return (con 3)))) (function-def "t" () dynamic ((ann-assign "a" "int" (call "something" ())) (assign ("b") (con 0)) (aug-assign "b" + "a") (return "b"))) (assert (compare (call "t" ()) ((== (con 3))))))))

;; conformance_suite/test_bind_boolop_type.py
(test-match SP program+ (term ((import-from "typing" ("Any")) (class "C" () ((function-def "f" (("self" dynamic)) "bool" ((return (con #t)))) (function-def "g" (("self" dynamic)) "bool" ((return (con #f)))) (function-def "x" (("self" dynamic)) "bool" ((return (bool-op and ((call (attribute "self" "f") ()) (call (attribute "self" "g") ())))))) (function-def "y" (("self" dynamic)) "bool" ((return (bool-op or ((call (attribute "self" "f") ()) (call (attribute "self" "g") ())))))))) (assert (compare (call (attribute "c" "x") ()) ((== (con #f))))) (assert (compare (call (attribute "c" "y") ()) ((== (con #t))))))))
...
(test-match SP program+ (term ((function-def "use" (("i" "object")) "object" ((return "i"))) (function-def "outer" (("x" "int")) "object" ((function-def "inner" () (con None) ((expr (call "use" ("x"))))) (return (call "use" ("x"))))) (assert (compare (call "outer" ((con 1))) ((== (con 1))))))))

;; conformance_suite/test_check_args_2.py
(test-match SP program+ (term ((function-def "use" (("i" "object")) "object" ((return "i"))) (function-def "outer" (("x" "int") ("y" "str")) "object" ((function-def "inner" () (con None) ((expr (call "use" ("x"))) (expr (call "use" ("y"))))) (expr (call "use" ("x"))) (return (call "use" ("y"))))) (assert (compare (call "outer" ((con 1) (con "yo"))) ((== (con "yo"))))))))

;; conformance_suite/test_check_args_3.py
(test-match SP program+ (term ((function-def "use" (("i" "object")) "object" ((return "i"))) (function-def "outer" (("x" "int") ("y" "str")) "object" ((function-def "inner" () (con None) ((expr (call "use" ("y"))))) (expr (call "use" ("x"))) (return (call "use" ("y"))))) (assert (compare (call "outer" ((con 1) (con "yo"))) ((== (con "yo"))))))))

;; conformance_suite/test_chkdict_literal.py
(test-match SP program+ (term ((import-from "__static__" ("CheckedDict")) (function-def "testfunc" () dynamic ((ann-assign "x" (subscript "CheckedDict" (tuple ("int" "str"))) (dict ())) (return "x"))) (assert (compare (call "type" ((call "f" ()))) ((== (subscript "chkdict" (tuple ("int" "str"))))))))))
...
(test-match SP program+ (term ((function-def "dec" (("f" dynamic)) dynamic ((return "f"))) (class "C" () ((function-def "foo" (("self" dynamic)) "int" ((return (con 3)))) (function-def "f" (("self" dynamic)) dynamic ((return (call (attribute "self" "foo") ())))))) (assert (compare (call (attribute (call "C" ()) "f") ()) ((== (con 3))))))))
...
(test-match SP program+ (term ((function-def "func" () dynamic ((expr (call "print" ((con "hi")))))) (expr (call "func" ())))))
...
(test-match SP program+ (term ((import-from "__static__" ("pydict")) (class "B" () (pass)) (class "D" ("B") (pass)) (function-def "testfunc" () dynamic ((ann-assign "x" "pydict" (dict (((call "B" ()) (con 42)) ((call "D" ()) (con 42))))) (return "x"))) (assert (compare (call "type" ((call "test" ()))) ((== "dict")))))))

;; conformance_suite/test_compile_checked_dict_explicit_dict_as_dict.py
(test-match SP program+ (term ((import-from "__static__" ("pydict")) (class "B" () (pass)) (class "D" ("B") (pass)) (function-def "testfunc" () dynamic ((ann-assign "x" "dict" (dict (((call "B" ()) (con 42)) ((call "D" ()) (con 42))))) (return "x"))) (assert (compare (call "type" ((call "test" ()))) ((== "dict")))))))

;; conformance_suite/test_compile_checked_dict_len.py
(test-match SP program+ (term ((import-from "__static__" ("CheckedDict")) (function-def "testfunc" () dynamic ((assign ("x") (call (subscript "CheckedDict" (tuple ("int" "str"))) ((dict (((con 1) (con "abc"))))))) (return (call "len" ("x"))))) (assert (compare (call "test" ()) ((== (con 1))))))))

;; conformance_suite/test_compile_checked_dict_opt_out_by_default.py
(test-match SP program+ (term ((class "B" () (pass)) (class "D" ("B") (pass)) (function-def "testfunc" () dynamic ((assign ("x") (dict (((call "B" ()) (con 42)) ((call "D" ()) (con 42))))) (return "x"))) (assert (compare (call "type" ((call "test" ()))) ((== "dict")))))))
...
(test-match SP program+ (term ((import-from "__static__" ("CheckedDict")) (class "B" () (pass)) (class "D" ("B") (pass)) (function-def "testfunc" () dynamic ((assign ("x") (call (subscript "CheckedDict" (tuple ("B" "int"))) ((dict (((call "D" ()) (con 42)) ((call "B" ()) (con 42))))))) (return "x"))) (assert (compare (call "type" ((call "test" ()))) ((== (subscript "chkdict" (tuple ("B" "int"))))))))))

;; conformance_suite/test_compile_checked_dict_shadowcode.py
(test-match SP program+ (term ((import-from "__static__" ("CheckedDict")) (class "B" () (pass)) (class "D" ("B") (pass)) (function-def "testfunc" () dynamic ((assign ("x") (call (subscript "CheckedDict" (tuple ("B" "int"))) ((dict (((call "B" ()) (con 42)) ((call "D" ()) (con 42))))))) (return "x"))) (assert (compare (call "type" ((call "test" ()))) ((== (subscript "chkdict" (tuple ("B" "int"))))))))))

;; conformance_suite/test_compile_checked_dict_type_specified.py
(test-match SP program+ (term ((import-from "__static__" ("CheckedDict")) (class "B" () (pass)) (class "D" ("B") (pass)) (function-def "testfunc" () dynamic ((ann-assign "x" (subscript "CheckedDict" (tuple ("B" "int"))) (call (subscript "CheckedDict" (tuple ("B" "int"))) ((dict (((call "D" ()) (con 42))))))) (return "x"))) (assert (compare (call "type" ((call "test" ()))) ((== (subscript "chkdict" (tuple ("B" "int"))))))))))

;; conformance_suite/test_compile_checked_dict_with_annotation.py
(test-match SP program+ (term ((import-from "__static__" ("CheckedDict")) (class "B" () (pass)) (function-def "testfunc" () dynamic ((ann-assign "x" (subscript "CheckedDict" (tuple ("B" "int"))) (dict (((call "B" ()) (con 42))))) (return "x"))) (assert (compare (call "type" ((call "test" ()))) ((== (subscript "chkdict" (tuple ("B" "int"))))))))))
...
(test-match SP program+ (term ((class "C" () (pass)) (function-def "mydecorator" (("x" dynamic)) dynamic ((return "C"))) (function-def "f" () dynamic ((return (con 42)))) (function-def "g" () dynamic ((return (call "f" ())))) (assert (compare (call "type" ((call "g" ()))) ((== "C")))))))

;; conformance_suite/test_dict_invoke.py
(test-match SP program+ (term ((import-from "__static__" ("pydict")) (function-def "f" (("x" dynamic)) dynamic ((ann-assign "y" "pydict" "x") (return (call (attribute "y" "get") ((con "foo")))))) (assert (compare (call "f" ((dict ()))) ((== (con None))))))))

;; conformance_suite/test_dict_invoke_ret.py
(test-match SP program+ (term ((import-from "__static__" ("pydict")) (function-def "g" () dynamic ((return (con None)))) (function-def "f" (("x" dynamic)) dynamic ((ann-assign "y" "pydict" "x") (assign ("z") (call (attribute "y" "get") ((con "foo")))) (assign ("z") (con None)) (return "z"))) (assert (compare (call "f" ((dict ()))) ((== (con None))))))))
...
(test-match SP program+ (term ((function-def "f" () dynamic ((assign ("l") (list ((con 1) (con 2) (con 3)))) (assign ("acc") (list ())) (for "x" "l" ((expr (call (attribute "acc" "append") ("x")))) ()) (return "acc"))) (assert (compare (call "f" ()) ((== (list ((con 1) (con 2) (con 3))))))))))
...
(test-match SP program+ (term ((import-from "__static__" ("inline")) (function-def "e" (("x" dynamic) ("y" dynamic)) dynamic ((return (bin-op + "x" "y")))) (function-def "f" (("x" dynamic) ("y" dynamic)) dynamic ((return (call "e" ("x" (con 3)))))) (function-def "g" () dynamic ((return (call "f" ((con 1) (con 2)))))) (assert (compare (call "g" ()) ((== (con 4))))))))

;; conformance_suite/test_inline_nested_arg.py
(test-match SP program+ (term ((import-from "__static__" ("inline")) (function-def "e" (("x" dynamic) ("y" dynamic)) dynamic ((return (bin-op + "x" "y")))) (function-def "f" (("x" dynamic) ("y" dynamic)) dynamic ((return (call "e" ("x" (con 3)))))) (function-def "g" (("a" dynamic) ("b" dynamic)) dynamic ((return (call "f" ("a" "b"))))) (assert (compare (call "g" ((con 1) (con 2))) ((== (con 4))))))))
...
(test-match SP program+ (term ((function-def "f" (("a" "int") ("b" "int")) "int" ((return (call "max" ("a" "b"))))) (assert (compare (call "id" ((call "f" ("p" "q")))) ((== (call "id" ("p")))))) (assert (compare (call "id" ((call "f" ("q" "p")))) ((== (call "id" ("q")))))))))
...
(test-match SP program+ (term ((function-def "f" (("a" "int") ("b" "int")) "int" ((return (call "min" ("a" "b"))))) (assert (compare (call "id" ((call "f" ("p" "q")))) ((== (call "id" ("p")))))) (assert (compare (call "id" ((call "f" ("q" "p")))) ((== (call "id" ("q")))))))))
...
(test-match SP program+ (term ((class "C" () ((function-def "__init__" (("self" dynamic)) dynamic ((ann-assign (attribute "self" "x") (subscript "Optional" "C") (con None)))))) (assert (compare (attribute "c" "x") ((== (con None))))))))
...
(test-match SP program+ (term ((function-def "f" () "int" ((assign ("l") (bin-op * (list ((con 1) (con 2) (con 3))) (con 2))) (return (call "len" ("l"))))) (assert (compare (call (attribute "mod" "f") ()) ((== (con 6))))))))

;; conformance_suite/test_multiply_list_exact_by_int_reverse.py
(test-match SP program+ (term ((function-def "f" () "int" ((assign ("l") (bin-op * (con 2) (list ((con 1) (con 2) (con 3))))) (return (call "len" ("l"))))) (assert (compare (call (attribute "mod" "f") ()) ((== (con 6))))))))
...
(test-match SP program+ (term ((class "Lol" () ((function-def "__len__" (("self" dynamic)) dynamic ((return (con 421)))))) (function-def "y" () dynamic ((return (call "len" ((call "Lol" ())))))) (assert (compare (call "y" ()) ((== (con 421))))))))
...
(test-match SP program+ (term ((import-from "__static__" ("PyDict")) (function-def "f" (("d" (subscript "PyDict" (tuple ("str" "int"))))) "str" ((return (subscript "d" (con 3))))) (assert (compare (call (attribute "mod" "f") ((dict (((con 3) (con "foo")))))) ((== (con "foo"))))))))
...
(test-match SP program+ (term ((import-from "typing" ("Optional")) (function-def "f" (("s" (subscript "Optional" "str"))) "str" ((return (bool-op or ("s" (con "hi")))))) (assert (compare (call "f" ((con "A"))) ((== (con "A"))))) (assert (compare (call "f" ((con None))) ((== (con "hi"))))))))
...
(test-match SP program+ (term ((import-from "typing" ("Any")) (function-def "testfunc" (("x" "str") ("y" "str")) "bool" ((return (compare "x" ((== "y")))))) (assert (compare (call "f" ((con "abc") (con "abc"))) ((== (con #t))))))))
...
(test-match SP program+ (term ((import-from "typing" ("List")) (function-def "f" (("l" (subscript "List" "int"))) dynamic ((return (bin-op * "l" (con 2))))) (assert (compare (call (attribute "mod" "f") ((list ((con 1) (con 2))))) ((== (list ((con 1) (con 2) (con 1) (con 2))))))) (assert (compare (call (attribute "mod" "f") ((call "MyList" ((list ((con 1) (con 2))))))) ((== (con "RESULT"))))))))

;; conformance_suite/test_seq_repeat_inexact_num.py
(test-match SP program+ (term ((function-def "f" (("num" "int")) dynamic ((return (bin-op * "num" (list ((con 1) (con 2))))))) (assert (compare (call (attribute "mod" "f") ((con 2))) ((== (list ((con 1) (con 2) (con 1) (con 2))))))) (assert (compare (call (attribute "mod" "f") ((call "MyInt" ((con 2))))) ((== (con "RESULT"))))))))

;; conformance_suite/test_seq_repeat_inexact_tuple.py
(test-match SP program+ (term ((import-from "typing" ("Tuple")) (function-def "f" (("t" (subscript "Tuple" "int"))) dynamic ((return (bin-op * "t" (con 2))))) (assert (compare (call (attribute "mod" "f") ((tuple ((con 1) (con 2))))) ((== (tuple ((con 1) (con 2) (con 1) (con 2))))))) (assert (compare (call (attribute "mod" "f") ((call "MyTuple" ((tuple ((con 1) (con 2))))))) ((== (con "RESULT"))))))))

;; conformance_suite/test_seq_repeat_list.py
(test-match SP program+ (term ((function-def "f" () dynamic ((assign ("l") (list ((con 1) (con 2)))) (return (bin-op * "l" (con 2))))) (assert (compare (call (attribute "mod" "f") ()) ((== (list ((con 1) (con 2) (con 1) (con 2))))))))))

;; conformance_suite/test_seq_repeat_list_reversed.py
(test-match SP program+ (term ((function-def "f" () dynamic ((assign ("l") (list ((con 1) (con 2)))) (return (bin-op * (con 2) "l")))) (assert (compare (call (attribute "mod" "f") ()) ((== (list ((con 1) (con 2) (con 1) (con 2))))))))))

;; conformance_suite/test_seq_repeat_tuple.py
(test-match SP program+ (term ((function-def "f" () dynamic ((assign ("t") (tuple ((con 1) (con 2)))) (return (bin-op * "t" (con 2))))) (assert (compare (call (attribute "mod" "f") ()) ((== (tuple ((con 1) (con 2) (con 1) (con 2))))))))))

;; conformance_suite/test_seq_repeat_tuple_reversed.py
(test-match SP program+ (term ((function-def "f" () dynamic ((assign ("t") (tuple ((con 1) (con 2)))) (return (bin-op * (con 2) "t")))) (assert (compare (call (attribute "mod" "f") ()) ((== (tuple ((con 1) (con 2) (con 1) (con 2))))))))))
...
(test-match SP program+ (term ((function-def "get_str" () "str" ((return (con "something here")))) (function-def "test" () "str" ((assign ((tuple ("a" "b"))) (call (attribute (call "get_str" ()) "split") ((con None) (con 1)))) (return "b"))) (assert (compare (call "test" ()) ((== (con "here"))))))))
...
(test-match SP program+ (term ((import-from "typing" ("List")) (function-def "f1" (("x" "List")) dynamic ((try-except-else-finally ((return (con None))) () () ((expr (call (attribute "x" "append") ((con "hi")))))))) (assert (compare "l" ((== (list ((con "hi"))))))))))
...
(test-match SP program+ (term ((assign ("x") (lambda (("x" dynamic)) "x")) (assign ("a") (call "x" ((con "hi")))) (assert (compare (attribute "mod" "a") ((== (con "hi"))))))))
...
(test-match SP program+ (term ((assign ("x") (con 0)) (if "x" (pass) ((function-def "f" () dynamic ((return (con 42)))))) (assert (compare (call (attribute "mod" "f") ()) ((== (con 42))))))))
