...
(test-match SP program+ (term ((class "C" () ((function-def "__init__" (("self" dynamic)) dynamic ((ann-assign (attribute "self" "x") (subscript "Optional" "C") (con None)))))) (assign ("c") (call "C" ())) (assert (compare (attribute "c" "x") ((== (con None))))))))
