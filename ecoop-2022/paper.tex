...
The basic primitives describe booleans and sized numbers, e.g., \code{int64}, \code{uint64}, \code{double}.
Two additional primitives, \code{Array} and \code{Vector}, describe collections.
...
\citet{pmmwplck-oopsla-2013} core calculus for Python language, foundational.
