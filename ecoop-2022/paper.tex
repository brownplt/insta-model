...
No way to write the dynamic type.
Instead, it fills in for absent annotations.
Either totally missing or a missing generic parameter.

%% TODO are there any types C[T0, T1] where you might want C[dyn, T1]? how to express?

Cannot appear everywhere ... ChkDict can't hold a Dynamic,
