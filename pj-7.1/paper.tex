...
The \SP{} type system does not include some features.
Each of the following is low priority, but they are rougly ordered from most
important (soonest to be implemented) to least.
