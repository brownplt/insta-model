...
%% - double-check section 4, can we be more convincing about soundness / what it is?
%% - reword 'fields' to attribute/descriptor/property?
%% - 

%% TODO for camera-ready
%% - reviews-r2: clarify gradual soundness again, what do we mean?
%%    (1) two layers of types+code for some algorithms ... esp. for data structures ... key to practical concrete
%%    (2) progressive types for other code
%%    ... in short, progressive types adapted to GT
%%   - try section 2 for this
...
with \emph{concrete} types~\cite{wnlov-popl-2010,mt-oopsla-2017}
...
To be clear, gradual soundness has a different focus than gradual typing.
Gradual typing in the traditional, broad sense is about finding a best-of-both worlds
combination of typed and untyped
code~\cite{st-sfp-2006,tf-dls-2006,mf-toplas-2009,gktff-sfp-2006}.
...
Gradual typing in the refined sense calls for a dynamic type
that satisfies the gradual guarantees~\cite{svcb-snapl-2015}.
...
type and allows missing and unknown types~(\cref{s:type-dynamic}).
...
A list of issue numbers follows each link.
...
The critical soundness issues were:
\code{\#}\spsoundness{36},
         \spsoundness{39},
         \spsoundness{53},
         \spsoundness{55}, and
