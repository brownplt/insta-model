...
%% - is \sqle _consistent_ or _compatible_ subtyping?
...
The next rules illustrate reads from Python dictionaries and checked dictionaries.
A Python dict may be deferenced by any value; the read promises a dynamically-typed result.
By contrast, a checked dict requires an index value that matches its type
and promises a typed result.
...
\begin{figure}[t]
  ...
  \begin{mathpar}
    \inferrule*[left=S-App]{
      ...
      \sptenv_0 \wtexpr \spapp{\spf_0}{\spexpr_1} : \spteval_1
    }
    ...
    %% TODO show dict write rules?
    %\inferrule*[left=PD-Set]{
    %  \sptenv_0 \wtexpr \spexpr_0 : \sptrawpydict
    %  \\\\
    %  \sptenv_0 \wtexpr \spexpr_1 : \sptobject
    %  \\\\
    ...
    %}{
    %  \sptenv_0 \wtexpr \spdictset{\spexpr_0}{\spexpr_1} : \sptnone
    %}
