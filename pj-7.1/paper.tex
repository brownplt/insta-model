...
%% TODO confirm with C&D 
%%  KC points out that variables and types are not too different so issue 50 may apply https://github.com/facebookincubator/cinder/issues/50
%%  perhaps every type should have an import; that's not a burden for Pyre users
...
\begin{itemize}
  \item TBD need categories, expect about 40 of these.
\end{itemize}
