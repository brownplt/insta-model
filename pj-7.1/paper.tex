...
but its partial adoption also led to an awkward workflow with a
...
The changes impose a maintenance burden, but enable performance improvements and low-cost checks.
...
initial warmup run to update the bytecode cache file and ignoring compilation time),
...
\noindent\bmname{nbody} ran on an even later commit:

\begin{center}
\footnotesize\url{https://github.com/facebookincubator/cinder/commit/144a21e66aeae5cde08847482249396b2e16eccc}
\end{center}
