...
Relative to these sources, the \SP{} takes some interesting turns
...
\begin{itemize}
  ...
  \item
    Instagram is / had been using Cython for performance.
...
\SP{} includes a dynamic type to accommodate untyped Python code.
Any un-annotated value or expression gets the dynamic type by default.
\SP{} does not make any predicitions / optimizations about dynamic code;
it assumes nothing and lets the Python runtime handle.

- lack of ann
- or, incorrect ann
- at toplevel, everything compatible
- diffirent rules inside data structures
