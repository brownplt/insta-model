...
and in Grace with the Graal partial-evaluation-based JIT~\cite{FILL}.
...
semantics~\cite{vss-popl-2017,FILL}.
...
to the top object type but allows implicit downcasts to every other type~\cite{FILL}.
...
\begin{itemize}
  \item
    ...
    to Pyre~\cite{pyre} and other types-for-Python proposals~\cite{FILL}.
...
A exhaustive performance evaluation~\cite{FILL} of a few small projects would be
especially useful.
  ...
  \item
    ...
    \begin{itemize}
      \item
        ...
        that a weak reference has the dynamic type~\cite{FILL}.
      ...
      \item
        ...
        Python type checkers, including mypy~\cite{FILL}.
      \item
...
\smallskip
{\centering\url{https://github.com/facebookincubator/cinder/commit/d0d071a9acf3e65700e7c6f8982c5087c700d116}}
