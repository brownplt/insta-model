...
\begin{itemize}
  ...
  \item
    ...
    issues in \SP{}.
    Four of these were soundness bugs.
...
and it compiles code on-the-fly to enable the same
...
recursive types.
Pyre and mypy some support for the first two kinds, but not for recursive types.
...
implementation of \SP{}---an important payoff given that \SP{} is running in
...
\begin{table}[t]
  \caption{Microbenchmark performance ratios. NB: data for nbody is pending.}
...
\Cref{a:microbench-detail} presents further benchmark details.
