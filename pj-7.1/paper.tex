...
%% TODO 2021-12-30 outline
%% NOTE strict modules not modeled
%% - what is language
%% - what properties
%% - what did in model, how to navigate?
%% - bug reports
...
%% TODO 2021-12-28
%% - model soundness argument = similar to Nom, Redex tests
%%   - Nom has dispatch modes .. SP does not, simpler
%%     - are dyn -> stat overrides allowed and do they affect soundness?
%% - while True break another example of modeling helping out
%%   it's a second implementation, helpful to find bugs
%%   TODO if SP folks say that "continue" version matters for production, ... umm something to think about for us
...
%% TODO model omits primitives because their typing is easy, separate hierarchy, clear boundaries
%% TODO paper-model focus on boundaries ... where can dyn slip in ... not a full semantics ... 
...
\begin{figure}[t]
  ...
  \fbox{$\sptenv \wtprog \spstmt \dashv \sptenv$}
  \begin{mathpar}
    \inferrule*{
    ...
    \inferrule*{
      \sptenv_1 = \sptclassdef{\spc_0}{\spc_1}{\sptvardef{\spx_0}{\sptype_0} \ldots}{\sptfundef{\spf_n}{\spc_0, \sptype_{dn}}{\sptype_{cn}}}
      \\\\
      %% TODO
      \emph{lookup parent}
      \\\\
      \emph{overrides are subtypes (not merely compatible)}
      \\\\
      \emph{fields and methods are well typed}
    }{
      \sptenv_0 \wtprog \spclassdef{\spc_0}{\spc_1}{\spvardef{\spx_0}{\sptype_0}{\spexpr_0} \ldots}{\spfundef{\spf_n}{\spself, \spann{\spx_n}{\sptype_{dn}}}{\sptype_{cn}}{\spexpr_n}} \dashv \sptenv_1
    }
  \end{mathpar}
  ...
  \begin{mathpar}
    ...
    \inferrule*{
      ...
      \sptenv_0 \wtexpr \spexpr_0[\spexpr_1] : \sptdyn
    }
    ...
    \inferrule*{
      ...
      \sptenv_0 \wtexpr \spexpr_0[\spexpr_1] : \sptype_1
    }
