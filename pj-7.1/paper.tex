...
%  Novel run-time check strategy, combines concrete and transient for ergonomics.
  ...
  to develope a model that capture the essence of its
  ...
  has also found several errors in the implementation, inlcuding fatal errors.
  ...
  such as JavaScript.
  %% FILL TODO SP is sound, be clearer why this makes sense for unsound people!
...
\begin{itemize}
  \item
    ...
    %% FILL SK: Relative to what? Also, reading "Evidence that gradual soundness
    %%   delivers Python-level performance" feels a bit like mockery, given how slow
    %%   Python is!
  \item
...
\section{A Programmer's View of \SP{}}
\label{s:tour}
