...
type soundness.
Specifically, we asked Redex to generate well-formed terms (using its default
...
By contrast to our Redex model, the typing judgment in~\cref{f:eval-type} is
not syntax directed.
...
and untyped objects.
Thorn is a new scripting language for the JVM; StrongScript is designed to
